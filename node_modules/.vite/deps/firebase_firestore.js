import { E as createMockUserToken, N as getModularInstance, O as deepEqual, P as getUA, R as isIndexedDBAvailable, S as FirebaseError, V as isSafari, b as Component, c as _getProvider, f as getApp, g as registerVersion, j as getDefaultEmulatorHostnameAndPort, l as _registerComponent, n as SDK_VERSION, u as _removeServiceInstance, v as LogLevel, y as Logger } from "./index.esm2017-DGyNZ426.js";
...
v.prototype.sa = function() {
	if (!this.s && (this.s = !0, this.N(), 0 != ia$1)) ba$1(this);
};
v.prototype.N = function() {
	if (this.o) for (; this.o.length;) this.o.shift()();
};
var ka$1 = Array.prototype.indexOf ? function(a, b) {
...
var za$1;
a: {
	var Aa$1 = "", Ba$1 = function() {
		var a = pa$1();
		if (wa$1) return /rv:([^\);]+)(\)|;)/.exec(a);
		if (ua$1) return /Edge\/([\d\.]+)/.exec(a);
		if (z$1) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
		if (xa$1) return /WebKit\/(\S+)/.exec(a);
		if (ta$1) return /(?:Version)[ \/]?(\S+)/.exec(a);
	}();
	Ba$1 && (Aa$1 = Ba$1 ? Ba$1[1] : "");
	if (z$1) {
		var Ca$1 = ya$1();
		if (null != Ca$1 && Ca$1 > parseFloat(Aa$1)) {
			za$1 = String(Ca$1);
			break a;
		}
	}
...
var Qa$1 = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");
function Ra$1(a, b) {
	let c, d;
	for (let e = 1; e < arguments.length; e++) {
		d = arguments[e];
		for (c in d) a[c] = d[c];
		for (let f = 0; f < Qa$1.length; f++) c = Qa$1[f], Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]);
	}
}
function Sa$1(a) {
	this.src = a;
...
Sa$1.prototype.add = function(a, b, c, d, e) {
	var f = a.toString();
	a = this.g[f];
	a || (a = this.g[f] = [], this.h++);
	var h = Ta$1(a, b, d, e);
	-1 < h ? (b = a[h], c || (b.ia = !1)) : (b = new Ja$1(b, this.src, f, !!d, e), b.ia = c, a.push(b));
	return b;
};
function Ua$1(a, b) {
	var c = b.type;
	if (c in a.g) {
		var d = a.g[c], e = ka$1(d, b), f;
		(f = 0 <= e) && Array.prototype.splice.call(d, e, 1);
		f && (Ka$1(b), 0 == a.g[c].length && (delete a.g[c], a.h--));
	}
}
...
function Ya$1(a, b, c, d, e) {
	if (d && d.once) return Za$1(a, b, c, d, e);
	if (Array.isArray(b)) {
		for (var f = 0; f < b.length; f++) Ya$1(a, b[f], c, d, e);
		return null;
	}
	c = $a$1(c);
	return a && a[Ha$1] ? a.O(b, c, p(d) ? !!d.capture : !!d, e) : ab(a, b, c, !1, d, e);
}
function ab(a, b, c, d, e, f) {
	...
	d.src = a;
	d.listener = c;
	if (a.addEventListener) oa$1 || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
...
function Za$1(a, b, c, d, e) {
	if (Array.isArray(b)) {
		for (var f = 0; f < b.length; f++) Za$1(a, b[f], c, d, e);
		return null;
	}
	c = $a$1(c);
	return a && a[Ha$1] ? a.P(b, c, p(d) ? !!d.capture : !!d, e) : ab(a, b, c, !0, d, e);
}
function fb(a, b, c, d, e) {
	if (Array.isArray(b)) for (var f = 0; f < b.length; f++) fb(a, b[f], c, d, e);
	else (d = p(d) ? !!d.capture : !!d, c = $a$1(c), a && a[Ha$1]) ? (a = a.i, b = String(b).toString(), b in a.g && (f = a.g[b], c = Ta$1(f, c, d, e), -1 < c && (Ka$1(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b], a.h--)))) : a && (a = bb(a)) && (b = a.g[b.toString()], a = -1, b && (a = Ta$1(b, c, d, e)), (c = -1 < a ? b[a] : null) && gb(c));
}
function gb(a) {
	if ("number" !== typeof a && a && !a.fa) {
		var b = a.src;
		if (b && b[Ha$1]) Ua$1(b.i, a);
		else {
			...
			(c = bb(b)) ? (Ua$1(c, a), 0 == c.h && (c.src = null, b[Va$1] = null)) : Ka$1(a);
		}
	}
}
function db(a) {
...
function C$1(a, b) {
	...
	a = a.S;
	d = b.type || b;
	if ("string" === typeof b) b = new w(b, a);
	else if (b instanceof w) b.target = b.target || a;
	else {
		var e = b;
		b = new w(d, a);
		Ra$1(b, e);
...
B$1.prototype.N = function() {
	...
	if (this.i) {
		var a = this.i, c;
		for (c in a.g) {
			for (var d = a.g[c], e = 0; e < d.length; e++) Ka$1(d[e]);
			delete a.g[c];
			a.h--;
		}
	}
...
function yb(a, b, c) {
	if ("function" === typeof a) c && (a = q$1(a, c));
	else if (a && "function" == typeof a.handleEvent) a = q$1(a.handleEvent, a);
...
function Db(a, b, c, d) {
	...
	for (var e = 0; e < c.length; e++) {
		var f = Ya$1(b, c[e], d || a.handleEvent, !1, a.h || a);
		if (!f) break;
		a.g[f.key] = f;
	}
}
function Fb(a) {
	Na$1(a.g, function(b, c) {
			...
			if (!(3 > u) && (3 != u || va$1 || this.g && (this.h.h || this.g.ja() || mc$1(this.g)))) {
				...
				if (this.i) {
					if (this.aa && !this.K) {
						...
						if (c = m) D$1(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"), this.K = !0, qc$1(this, c);
						else {
							this.i = !1;
							this.o = 3;
							F$1(12);
					...
					4 == u && I(this);
					this.i && !this.J && (4 == u ? sc$1(this.l, this) : (this.i = !1, jc$1(this)));
				} else tc$1(this.g), 400 == c && 0 < h.indexOf("Unknown SID") ? (this.o = 3, F$1(12)) : (this.o = 0, F$1(13)), I(this), pc$1(this);
			}
		}
	} catch (u) {}
};
...
function rc$1(a, b, c) {
	let d = !0, e;
	for (; !a.J && a.C < c.length;) if (e = uc$1(a, c), e == fc$1) {
		...
		d = !1;
		break;
	} else D$1(a.j, a.m, e, null), qc$1(a, e);
	oc$1(a) && e != fc$1 && e != ec$1 && (a.h.g = "", a.C = 0);
	4 != b || 0 != c.length || a.h.h || (a.o = 1, F$1(16), d = !1);
	a.i = a.i && d;
	d ? 0 < c.length && !a.ba && (a.ba = !0, b = a.l, b.g == a && b.ca && !b.M && (b.l.info("Great, no buffering proxy detected. Bytes received: " + c.length), vc$1(b), b.M = !0, F$1(11))) : (D$1(a.j, a.m, c, "[Invalid Chunked Response]"), I(a), pc$1(a));
}
k$1.mb = function() {
	if (this.g) {
		var a = H$1(this.g), b = this.g.ja();
		this.C < b.length && (nc$1(this), rc$1(this, a, b), this.i && 4 != a && jc$1(this));
	}
};
function uc$1(a, b) {
	...
	if (isNaN(c)) return ec$1;
	d += 1;
	if (d + c > b.length) return fc$1;
	b = b.slice(d, d + c);
	a.C = d + c;
	return b;
}
		...
		if (0 != c.H && (c.g == a || xc$1(c.i, a))) {
			if (!a.K && xc$1(c.i, a) && 3 == c.H) {
				...
				if (Array.isArray(d) && 3 == d.length) {
					...
					if (0 == e[0]) {
						a: if (!c.u) {
							if (c.g) if (c.g.G + 3e3 < a.G) yc$1(c), zc$1(c);
							else break a;
							Ac$1(c);
							F$1(18);
						}
			...
			} else if ((a.K || c.g == a) && yc$1(c), !x$1(b)) for (e = c.Ja.g.parse(b), b = 0; b < e.length; b++) {
				let m = e[b];
				c.V = m[0];
				m = m[1];
				if (2 == c.H) if ("c" == m[0]) {
					...
					if (la) {
						...
						if (Ma) {
							var f = d.i;
							f.g || -1 == Ma.indexOf("spdy") && -1 == Ma.indexOf("quic") && -1 == Ma.indexOf("h2") || (f.j = f.l, f.g = /* @__PURE__ */ new Set(), f.h && (Cc$1(f, f.h), f.h = null));
						}
						if (d.F) {
					...
					0 < c.j.length && Gc$1(c);
				} else "stop" != m[0] && "close" != m[0] || J$1(c, 7);
				else 3 == c.H && ("stop" == m[0] || "close" == m[0] ? "stop" == m[0] ? J$1(c, 7) : Hc$1(c) : "noop" != m[0] && c.h && c.h.Aa(m), c.A = 0);
			}
		}
		Ob(4);
	} catch (m) {}
...
function Kc$1(a, b) {
	...
	else if (aa$1(a) || "string" === typeof a) Array.prototype.forEach.call(a, b, void 0);
	else for (var c = Jc$1(a), d = Ic$1(a), e = d.length, f = 0; f < e; f++) b.call(void 0, d[f], c && c[f], a);
}
...
function M$1(a) {
	...
	if (a instanceof M$1) {
		...
		Qc$1(this, c);
		this.o = a.o;
	} else a && (b = String(a).match(Lc$1)) ? (this.h = !1, Nc$1(this, b[1] || "", !0), this.s = Rc$1(b[2] || ""), this.g = Rc$1(b[3] || "", !0), Oc$1(this, b[4]), this.l = Rc$1(b[5] || "", !0), Qc$1(this, b[6] || "", !0), this.o = Rc$1(b[7] || "")) : (this.h = !1, this.i = new Pc$1(null, this.h));
}
M$1.prototype.toString = function() {
	var a = [], b = this.j;
	b && a.push(Sc$1(b, Tc$1, !0), ":");
	var c = this.g;
	if (c || "file" == b) a.push("//"), (b = this.s) && a.push(Sc$1(b, Tc$1, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.m, null != c && a.push(":", String(c));
	if (c = this.l) this.g && "/" != c.charAt(0) && a.push("/"), a.push(Sc$1(c, "/" == c.charAt(0) ? Uc$1 : Vc$1, !0));
...
function Qc$1(a, b, c) {
	b instanceof Pc$1 ? (a.i = b, Xc$1(a.i, a.h)) : (c || (b = Sc$1(b, Yc$1)), a.i = new Pc$1(b, a.h));
}
function K$1(a, b, c) {
	a.i.set(b, c);
}
...
function Sc$1(a, b, c) {
	return "string" === typeof a ? (a = encodeURI(a).replace(b, Zc$1), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null;
}
function Zc$1(a) {
	a = a.charCodeAt(0);
...
function N$1(a) {
	a.g || (a.g = /* @__PURE__ */ new Map(), a.h = 0, a.i && Mc$1(a.i, function(b, c) {
...
k$1.Z = function(a) {
	N$1(this);
	let b = [];
	if ("string" === typeof a) ad(this, a) && (b = b.concat(this.g.get(O$1(this, a))));
	else {
...
function kc$1(a, b, c) {
	$c$1(a, b);
	0 < c.length && (a.i = null, a.g.set(O$1(a, b), ma$1(c)), a.h += c.length);
}
...
function jd(a, b) {
	...
	if (l.Image) {
		const d = new Image();
		d.onload = ha$1(kd, c, d, "TestLoadImage: loaded", !0, b);
		d.onerror = ha$1(kd, c, d, "TestLoadImage: error", !1, b);
		d.onabort = ha$1(kd, c, d, "TestLoadImage: abort", !1, b);
		d.ontimeout = ha$1(kd, c, d, "TestLoadImage: timeout", !1, b);
...
k$1.ha = function(a, b, c, d) {
	...
	!(0 <= ka$1(ud, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
	...
	if (a.h && "undefined" != typeof goog && (!a.C[1] || 4 != H$1(a) || 2 != a.da())) {
		if (a.v && 4 == H$1(a)) yb(a.La, 0, a);
			...
			try {
				...
				if (c) C$1(a, "complete"), C$1(a, "success");
				else {
					a.m = 6;
					try {
...
function Cd(a, b, c) {
	...
	d || (c = Bd(c), "string" === typeof a || K$1(a, b, c));
}
function Dd(a, b, c) {
...
function Hc$1(a) {
	...
	if (3 == a.H) {
		...
		c || (b.g = lc$1(b.l, null), b.g.ha(b.v));
		b.G = Date.now();
		jc$1(b);
	}
	Hd(a);
...
function Id(a, b) {
	if (Bc$1(a.i) >= a.i.j - (a.m ? 1 : 0)) return !1;
...
k$1.Na = function(a) {
	if (this.m) if (this.m = null, 1 == this.H) {
		if (!a) {
			...
			this.P ? (K$1(c, "$req", b), K$1(c, "SID", "null"), e.aa = !0, gc$1(e, c, null)) : gc$1(e, c, b);
			this.H = 2;
		}
	...
	a: {
		...
		for (;;) {
			...
			for (let t = 0; t < c; t++) {
				...
				const u = e[t].map;
				m -= f;
				if (0 > m) f = Math.max(0, e[t].g - 100), n = !1;
				else try {
					id(u, h, "req" + m + "_");
				} catch (L) {
					d && d(u);
...
k$1.jb = function() {
	this.B && (this.B = null, this.l.info("BP detection timeout reached."), this.l.info("Buffering proxy detected and switch to long-polling!"), this.G = !1, this.M = !0, F$1(10), zc$1(this), Md(this));
};
function vc$1(a) {
...
function sc$1(a, b) {
	...
	if (a.g == b) {
		...
		a.g = null;
		var d = 2;
	} else if (xc$1(a.i, b)) c = b.F, Ec$1(a.i, b), d = 1;
	else return;
	if (0 != a.H) {
		if (b.i) if (1 == d) {
			c = b.s ? b.s.length : 0;
		...
		else if (e = b.o, 3 == e || 0 == e && 0 < b.ca || !(1 == d && Id(a, b) || 2 == d && Ac$1(a))) switch (c && 0 < c.length && (b = a.i, b.i = b.i.concat(c)), e) {
			case 1:
				J$1(a, 5);
				break;
			case 4:
...
function Hd(a) {
	...
	if (a.h) {
		const b = fd(a.i);
		if (0 != b.length || 0 != a.j.length) na$1(a.ma, b), na$1(a.ma, a.j), a.i.i.length = 0, ma$1(a.j), a.j.length = 0;
		a.h.ya();
	}
}
function Dc$1(a, b, c) {
	var d = c instanceof M$1 ? G$1(c) : new M$1(c);
	if ("" != d.g) b && (d.g = b + "." + d.g), Oc$1(d, d.m);
	else {
		var e = l.location;
		d = e.protocol;
...
function lc$1(a, b, c) {
	...
	b = c && a.Ha && !a.va ? new P(new ld({ ob: !0 })) : new P(a.va);
	b.Oa(a.J);
	return b;
}
k$1.isActive = function() {
...
k$1.Va = function() {};
function Od() {
	if (z$1 && !(10 <= Number(Fa$1))) throw Error("Environmental error: no available transport.");
}
...
function Q$1(a, b) {
	...
	this.g.U = a;
	(a = b && b.cc) && !x$1(a) && (this.g.o = a);
	this.A = b && b.supportsCrossDomainXhr || !1;
	this.v = b && b.sendRawJson || !1;
	(b = b && b.httpSessionIdParam) && !x$1(b) && (this.g.F = b, a = this.h, null !== a && b in a && (a = this.h, b in a && delete a[b]));
	this.j = new R(this);
}
r(Q$1, B$1);
...
S$1.prototype.j = function(a, b) {
	...
	for (var c = b - this.blockSize, d = this.m, e = this.h, f = 0; f < b;) {
		...
		if ("string" === typeof a) {
			for (; f < b;) if (d[e++] = a.charCodeAt(f++), e == this.blockSize) {
				Sd(this, d);
				e = 0;
				break;
			}
...
var sa$1 = {};
function Td(a) {
	return -128 <= a && 128 > a ? ra$1(a, function(b) {
		return new T([b | 0], 0 > b ? -1 : 0);
	}) : new T([a | 0], 0 > a ? -1 : 0);
}
function U$1(a) {
	if (isNaN(a) || !isFinite(a)) return V$1;
	if (0 > a) return W$1(U$1(-a));
...
function Vd(a, b) {
	...
	if ("-" == a.charAt(0)) return W$1(Vd(a.substring(1), b));
...
k$1.toString = function(a) {
	...
	if (X$1(this)) return "-" + W$1(this).toString(a);
...
k$1.R = function(a) {
	if (Y$1(this) || Y$1(a)) return V$1;
	if (X$1(this)) return X$1(a) ? W$1(this).R(W$1(a)) : W$1(W$1(this).R(a));
	if (X$1(a)) return W$1(this.R(W$1(a)));
...
function Yd(a, b) {
	if (Y$1(b)) throw Error("division by zero");
	if (Y$1(a)) return new ae$1(V$1, V$1);
	if (X$1(a)) return b = Yd(W$1(a), b), new ae$1(W$1(b.g), W$1(b.h));
	if (X$1(b)) return b = Yd(a, W$1(b)), new ae$1(W$1(b.g), b.h);
	if (30 < a.g.length) {
		if (X$1(a) || X$1(b)) throw Error("slowDivide_ only works with positive integers.");
		for (var c = Wd, d = b; 0 >= d.X(a);) c = be$1(c), d = be$1(d);
	...
	for (e = V$1; 0 <= a.X(b);) {
		...
		f = U$1(c);
		for (h = f.R(b); X$1(h) || 0 < h.X(a);) c -= d, f = U$1(c), h = f.R(b);
		Y$1(f) && (f = Wd);
		e = e.add(f);
		a = Zd(a, h);
	}
...
/** A user with a null UID. */ V.UNAUTHENTICATED = new V(null), V.GOOGLE_CREDENTIALS = new V("google-credentials-uid"), V.FIRST_PARTY = new V("first-party-uid"), V.MOCK_USER = new V("mock-user");
/**
* @license
* Copyright 2017 Google LLC
*
...
/** An error returned by a Firestore operation. */ var U = class extends FirebaseError {
	/** @hideconstructor */
	constructor(t, e) {
...
var z = class {
	constructor(t) {
		this.t = t, this.currentUser = V.UNAUTHENTICATED, this.i = 0, this.forceRefresh = !1, this.auth = null;
	}
	start(t, e) {
		let n = this.i;
		...
		const r = () => {
			...
			N("FirebaseAuthCredentialsProvider", "Auth detected"), this.auth = t, this.auth.addAuthTokenListener(this.o), r();
		};
		this.t.onInit(((t) => o(t))), setTimeout((() => {
			if (!this.auth) {
				const t = this.t.getImmediate({ optional: !0 });
				t ? o(t) : (N("FirebaseAuthCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new K());
			}
		}), 0), r();
	}
	getToken() {
		const t = this.i, e = this.forceRefresh;
		return this.forceRefresh = !1, this.auth ? this.auth.getToken(e).then(((e) => this.i !== t ? (N("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e ? (F("string" == typeof e.accessToken), new G(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
	}
	invalidateToken() {
		this.forceRefresh = !0;
	}
...
var Y = class {
	...
	start(t, e) {
		const n = (t) => {
			...
			return this.T = t.token, N("FirebaseAppCheckTokenProvider", `Received ${n ? "new" : "existing"} token.`), n ? e(t.token) : Promise.resolve();
		};
		this.o = (e) => {
		...
		this.I.onInit(((t) => s(t))), setTimeout((() => {
			if (!this.appCheck) {
				const t = this.I.getImmediate({ optional: !0 });
				t ? s(t) : N("FirebaseAppCheckTokenProvider", "AppCheck not yet detected");
			}
		}), 0);
	}
	getToken() {
		const t = this.forceRefresh;
		return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(t).then(((t) => t ? (F("string" == typeof t.token), this.T = t.token, new J(t.token)) : null)) : Promise.resolve(null);
	}
	invalidateToken() {
		this.forceRefresh = !0;
	}
...
*/ var tt = class {
	static A() {
		const t = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", e = Math.floor(256 / 62) * 62;
		let n = "";
		for (; n.length < 20;) {
			const s = Z(40);
			for (let i = 0; i < s.length; ++i) n.length < 20 && s[i] < e && (n += t.charAt(s[i] % 62));
		}
		return n;
	}
};
...
* `readTime`.
*/ function yt(t, e) {
	const n = t.toTimestamp().seconds, s = t.toTimestamp().nanoseconds + 1;
	return new It(rt.fromTimestamp(1e9 === s ? new it(n + 1, 0) : new it(n, s)), ht.empty(), e);
}
...
var Pt = class Pt {
	constructor(t, e) {
		this.action = t, this.transaction = e, this.aborted = !1, this.v = new K(), this.transaction.oncomplete = () => {
			this.v.resolve();
	...
	abort(t) {
		t && this.v.reject(t), this.aborted || (N("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), this.aborted = !0, this.transaction.abort());
	}
	P() {
	...
	*/ store(t) {
		return new Ct(this.transaction.objectStore(t));
	}
};
/**
	...
	async runTransaction(t, e, n, s) {
		...
		for (;;) {
			...
			try {
				...
				const e = Pt.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).next(((t) => (e.P(), t))).catch(((t) => (e.abort(t), Rt.reject(t)))).toPromise();
				return r.catch((() => {})), await e.R, r;
			} catch (t) {
				const e = t, n = "FirebaseError" !== e.name && r < 3;
				if (N("SimpleDb", "Transaction failed with error:", e.message, "Retrying:", n), this.close(), !n) return Promise.reject(e);
			}
		}
	}
	close() {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ var St = class extends U {
	constructor(t, e) {
...
/** Implements the steps for backfilling indexes. */ var $t = class {
	constructor(t, e) {
	...
	/** Writes index entries until the cap is reached. Returns the number of documents processed. */ st(t, e) {
		...
		return Rt.doWhile((() => !0 === i && s > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(t).next(((e) => {
			if (null !== e && !n.has(e)) return N("IndexBackiller", `Processing collection: ${e}`), this.it(t, e, s).next(((t) => {
				s -= t, n.add(e);
			}));
			i = !1;
		})))).next((() => e - s));
	...
	*/ it(t, e, n) {
		return this.localStore.indexManager.getMinOffsetFromCollectionGroup(t, e).next(((s) => this.localStore.localDocuments.getNextDocuments(t, e, s, n).next(((n) => {
			const i = n.changes;
			return this.localStore.indexManager.updateIndexEntries(t, i).next((() => this.rt(s, n))).next(((n) => (N("IndexBackiller", `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(t, e, n)))).next((() => i.size));
		}))));
	}
...
*/ var Wt = {}, Ht = [
	...
	"prefixPath",
	"documentId"
], Xt = ["canonicalId", "targetId"], Zt = ["targetId", "path"], te = ["path", "targetId"], ee = ["collectionId", "parent"], ne = ["indexId", "uid"], se = ["uid", "sequenceNumber"], ie = [
	"indexId",
	"uid",
	"arrayValue",
	"directionalValue",
...
var Ie = class {
	constructor(t, e, n, s) {
		...
		let i = 1;
		for (; !t.isEmpty();) if (i = e ? n(t.key, e) : 1, e && s && (i *= -1), i < 0) t = this.isReverse ? t.left : t.right;
		else {
			if (0 === i) {
...
*/ var Ve = class Ve {
	...
	[Symbol.iterator]() {
		let t = 0;
		return { next: () => t < this.binaryString.length ? {
...
var Se = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
* limitations under the License.
*/
var Fe = { mapValue: { fields: { __type__: { stringValue: "__max__" } } } }, Be = { nullValue: "NULL_VALUE" };
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function qe(t, e) {
	...
	switch (n) {
		...
		case 4: return Me(t).isEqual(Me(e));
		...
		case 9: return nt(t.arrayValue.values || [], e.arrayValue.values || [], qe);
...
function Ke(t, e) {
	...
	switch (n) {
		case 0:
		case 9007199254740991: return 0;
		case 1: return et(t.booleanValue, e.booleanValue);
		case 2: return function(t, e) {
			const n = Ce(t.integerValue || t.doubleValue), s = Ce(e.integerValue || e.doubleValue);
			return n < s ? -1 : n > s ? 1 : n === s ? 0 : isNaN(n) ? isNaN(s) ? 0 : -1 : 1;
		}(t, e);
		case 3: return Ge(t.timestampValue, e.timestampValue);
		case 4: return Ge(Me(t), Me(e));
		case 5: return et(t.stringValue, e.stringValue);
		case 6: return function(t, e) {
			const n = xe(t), s = xe(e);
...
function je(t) {
	...
	}(t.timestampValue) : "stringValue" in t ? t.stringValue : "bytesValue" in t ? xe(t.bytesValue).toBase64() : "referenceValue" in t ? (n = t.referenceValue, ht.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
		let e = "[", n = !0;
...
function ze(t) {
	switch (Le(t)) {
		...
		case 6: return xe(t.bytesValue).approximateByteSize();
		case 7: return t.referenceValue.length;
		case 9: return (t.arrayValue.values || []).reduce(((t, e) => t + ze(e)), 0);
...
/** Returns the lowest value for the given value type (inclusive). */ function nn(t) {
	return "nullValue" in t ? Be : "booleanValue" in t ? { booleanValue: !1 } : "integerValue" in t || "doubleValue" in t ? { doubleValue: NaN } : "timestampValue" in t ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "stringValue" in t ? { stringValue: "" } : "bytesValue" in t ? { bytesValue: "" } : "referenceValue" in t ? We(Oe.empty(), ht.empty()) : "geoPointValue" in t ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "arrayValue" in t ? { arrayValue: {} } : "mapValue" in t ? { mapValue: {} } : O();
}
/** Returns the largest value for the given value type (exclusive). */ function sn(t) {
	return "nullValue" in t ? { booleanValue: !1 } : "booleanValue" in t ? { doubleValue: NaN } : "integerValue" in t || "doubleValue" in t ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "timestampValue" in t ? { stringValue: "" } : "stringValue" in t ? { bytesValue: "" } : "bytesValue" in t ? We(Oe.empty(), ht.empty()) : "referenceValue" in t ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "geoPointValue" in t ? { arrayValue: {} } : "arrayValue" in t ? { mapValue: {} } : "mapValue" in t ? Fe : O();
}
function rn(t, e) {
...
*/ var un = class un {
	...
	*/ getFieldsMap(t) {
		...
		for (let n = 0; n < t.length; ++n) {
			...
			Ze(s) && s.mapValue.fields || (s = { mapValue: { fields: {} } }, e.mapValue.fields[t.get(n)] = s), e = s;
		}
...
function ln(t, e, n) {
	...
	for (let i = 0; i < t.position.length; i++) {
		...
		if (r.field.isKeyField()) s = ht.comparator(ht.fromName(o.referenceValue), n.key);
		else s = Ke(o, n.data.field(r.field));
...
*/ function fn(t, e) {
	...
	for (let n = 0; n < t.position.length; n++) if (!qe(t.position[n], e.position[n])) return !1;
	return !0;
}
/**
* @license
...
function En(t) {
	if (t instanceof mn) return t.field.canonicalString() + t.op.toString() + Qe(t.value);
	if (In(t)) return t.filters.map(((t) => En(t))).join(",");
	{
...
function An(t, e) {
	return t instanceof mn ? function(t, e) {
		...
		if (e instanceof gn && t.op === e.op && t.filters.length === e.filters.length) return t.filters.reduce(((t, n, s) => t && An(n, e.filters[s])), !0);
		return !1;
	}(t, e) : void O();
}
function vn(t, e) {
...
/** Filter that matches on key fields within an array. */ var bn = class extends mn {
	constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ var Vn = class extends mn {
	constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ var Dn = class extends mn {
	constructor(t, e) {
...
/** A Filter that implements the IN operator. */ var Cn = class extends mn {
	constructor(t, e) {
		super(t, "in", e);
	}
	matches(t) {
...
/** A Filter that implements the not-in operator. */ var xn = class extends mn {
	constructor(t, e) {
		super(t, "not-in", e);
	}
	matches(t) {
		if (Ue(this.value.arrayValue, { nullValue: "NULL_VALUE" })) return !1;
		const e = t.data.field(this.field);
		return null !== e && !Ue(this.value.arrayValue, e);
	}
};
/** A Filter that implements the array-contains-any operator. */ var Nn = class extends mn {
	constructor(t, e) {
...
function $n(t) {
	...
	if (null === e.dt) {
		...
		null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map(((t) => En(t))).join(","), t += "|ob:", t += e.orderBy.map(((t) => function(t) {
			return t.field.canonicalString() + t.dir;
		}(t))).join(","), Ft(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", t += e.startAt.inclusive ? "b:" : "a:", t += e.startAt.position.map(((t) => Qe(t))).join(",")), e.endAt && (t += "|ub:", t += e.endAt.inclusive ? "a:" : "b:", t += e.endAt.position.map(((t) => Qe(t))).join(",")), e.dt = t;
	}
	return e.dt;
}
function On(t, e) {
...
var Un = class {
	...
	*/
	constructor(t, e = null, n = [], s = [], i = null, r = "F", o = null, u = null) {
		this.path = t, this.collectionGroup = e, this.explicitOrderBy = n, this.filters = s, this.limit = i, this.limitType = r, this.startAt = o, this.endAt = u, this.wt = null, this._t = null, this.startAt, this.endAt;
	}
};
...
*/ function Hn(t) {
	...
	if (null === e.wt) {
		e.wt = [];
		const t = zn(e), n = jn(e);
		if (null !== t && null === n) t.isKeyField() || e.wt.push(new dn(t)), e.wt.push(new dn(at.keyField(), "asc"));
		else {
			let t = !1;
...
function es(t) {
	return `Query(target=${function(t) {
		...
		return null !== t.collectionGroup && (e += " collectionGroup=" + t.collectionGroup), t.filters.length > 0 && (e += `, filters: [${t.filters.map(((t) => Rn(t))).join(", ")}]`), Ft(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map(((t) => function(t) {
			return `${t.field.canonicalString()} (${t.dir})`;
		}(t))).join(", ")}]`), t.startAt && (e += ", startAt: ", e += t.startAt.inclusive ? "b:" : "a:", e += t.startAt.position.map(((t) => Qe(t))).join(",")), t.endAt && (e += ", endAt: ", e += t.endAt.inclusive ? "a:" : "b:", e += t.endAt.position.map(((t) => Qe(t))).join(",")), `Target(${e})`;
...
/** Returns whether `doc` matches the constraints of `query`. */ function ns(t, e) {
	return e.isFoundDocument() && function(t, e) {
		...
		for (const n of Hn(t)) if (!n.field.isKeyField() && null === e.data.field(n.field)) return !1;
		return !0;
	}(t, e) && function(t, e) {
		for (const n of t.filters) if (!n.matches(e)) return !1;
		return !0;
	}(t, e) && function(t, e) {
		if (t.startAt && !function(t, e, n) {
			const s = ln(t, e, n);
...
*/ function Is(t, e) {
	if (t.useProto3Json) {
		...
		if (e === Infinity) return { doubleValue: "Infinity" };
		if (e === -Infinity) return { doubleValue: "-Infinity" };
	}
	return { doubleValue: Bt(e) ? "-0" : e };
}
/**
...
* limitations under the License.
*/
/** Used to represent a field transform on a mutation. */ var As = class {
	constructor() {
		this._ = void 0;
	}
};
...
*/ function vs(t, e, n) {
	return t instanceof bs ? function(t, e) {
		...
		return e && Ne(e) && (e = ke(e)), e && (n.fields.__previous_value__ = e), { mapValue: n };
...
/** Transforms an array value via a union operation. */ var Vs = class extends As {
	constructor(t) {
...
/** Transforms an array value via a remove operation. */ var Ds = class extends As {
	constructor(t) {
		super(), this.elements = t;
	}
};
...
* limitations under the License.
*/
/** A field path and the TransformOperation to perform upon it. */ var Ms = class {
	constructor(t, e) {
...
*/ function Us(t, e, n) {
	t instanceof js ? function(t, e, n) {
		...
		if (!Bs(t.precondition, e)) return void e.convertToUnknownDocument(n.version);
...
*/ function Ks(t, e, n, s) {
	return t instanceof js ? function(t, e, n, s) {
		...
		if (r.setAll(Ws(t)), r.setAll(i), e.convertToFoundDocument(e.version, r).setHasLocalMutations(), null === n) return null;
		return n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map(((t) => t.field)));
	}(t, e, n, s) : function(t, e, n) {
		if (Bs(t.precondition, e)) return e.convertToNoDocument(e.version).setHasLocalMutations(), null;
		return n;
	}(t, e, n);
}
/**
...
/** A mutation that deletes the document at the given key. */ var Ys = class extends Ls {
	constructor(t, e) {
...
*/ var Zs = class {
	...
	*/ applyToRemoteDocument(t, e) {
		...
		for (let e = 0; e < this.mutations.length; e++) {
			...
			if (s.key.isEqual(t.key)) Us(s, t, n[e]);
		}
	}
	/**
...
/** The result of applying a mutation batch to the backend. */ var ti = class ti {
	constructor(t, e, n, s) {
...
function oi(t) {
	switch (t) {
		...
		case q.INTERNAL:
		case q.UNAVAILABLE:
		case q.UNAUTHENTICATED: return !1;
...
*/
function ui(t) {
	if (void 0 === t) return k("GRPC error has no .code"), q.UNKNOWN;
	switch (t) {
		case ii.OK: return q.OK;
		case ii.CANCELLED: return q.CANCELLED;
		case ii.UNKNOWN: return q.UNKNOWN;
		case ii.DEADLINE_EXCEEDED: return q.DEADLINE_EXCEEDED;
		case ii.RESOURCE_EXHAUSTED: return q.RESOURCE_EXHAUSTED;
		case ii.INTERNAL: return q.INTERNAL;
		case ii.UNAVAILABLE: return q.UNAVAILABLE;
		case ii.UNAUTHENTICATED: return q.UNAUTHENTICATED;
		case ii.INVALID_ARGUMENT: return q.INVALID_ARGUMENT;
		case ii.NOT_FOUND: return q.NOT_FOUND;
		case ii.ALREADY_EXISTS: return q.ALREADY_EXISTS;
		case ii.PERMISSION_DENIED: return q.PERMISSION_DENIED;
		case ii.FAILED_PRECONDITION: return q.FAILED_PRECONDITION;
		case ii.ABORTED: return q.ABORTED;
		case ii.OUT_OF_RANGE: return q.OUT_OF_RANGE;
		case ii.UNIMPLEMENTED: return q.UNIMPLEMENTED;
		case ii.DATA_LOSS: return q.DATA_LOSS;
		default: return O();
	}
}
/**
...
/** The global singleton instance of `TestingHooks`. */ var ai = null;
/**
* @license
* Copyright 2023 Google LLC
*
...
var wi = class wi {
	constructor(t, e, n) {
		...
		if (t.length > 0 && 0 === this.hashCount) throw new _i(`Invalid hash count: ${n}`);
		if (0 === t.length && 0 !== e) throw new _i(`Invalid padding when bitmap length is 0: ${e}`);
	...
	/** Create bloom filter for testing purposes only. */ static create(t, e, n) {
		const s = t % 8 == 0 ? 0 : 8 - t % 8, r = new wi(new Uint8Array(Math.ceil(t / 8)), s, e);
...
/** Tracks the internal state of a Watch target. */ var Ti = class {
	constructor() {
		/**
		* The number of pending responses (adds or removes) that we are waiting on.
		* We only consider targets active that have no pending responses.
		*/
		this.St = 0, this.Dt = vi(), this.Ct = Ve.EMPTY_BYTE_STRING, this.xt = !1, this.Nt = !0;
	}
	/**
...
var Ei = class {
	...
	*/ re(t, e) {
		...
		try {
			...
			if (t instanceof Pe) return M("Decoding the base64 bloom filter in existence filter failed (" + t.message + "); ignoring the bloom filter and falling back to full re-query."), 1;
			throw t;
		}
		try {
			c = new wi(u, r, o);
		} catch (t) {
			return M(t instanceof _i ? "BloomFilter error: " : "Applying bloom filter failed: ", t), 1;
		}
		if (0 === c.It) return 1;
	...
	*/ ce(t) {
		...
		this.zt.forEach(((t, e) => {
			...
			e.forEachWhile(((t) => {
				const e = this.se(t);
				return !e || "TargetPurposeLimboResolution" === e.purpose || (s = !1, !1);
			})), s && (n = n.add(t));
...
*/
function Si(t, e) {
	return t.useProto3Json || Ft(e) ? e : { value: e };
}
/**
...
*/
function Di(t, e) {
	if (t.useProto3Json) return `${(/* @__PURE__ */ new Date(1e3 * e.seconds)).toISOString().replace(/\.\d*/, "").replace("Z", "")}.${("000000000" + e.nanoseconds).slice(-9)}Z`;
	return {
		seconds: "" + e.seconds,
		nanos: e.nanoseconds
	};
...
function Ki(t, e, n) {
	const s = Oi(t, e.name), i = Ni(e.updateTime), r = e.createTime ? Ni(e.createTime) : rt.min(), o = new un({ mapValue: { fields: e.fields } }), u = an.newFoundDocument(s, i, r, o);
	return n && u.setHasCommittedMutations(), n ? u.setHasCommittedMutations() : u;
}
function Gi(t, e) {
	return "found" in e ? function(t, e) {
		F(!!e.found), e.found.name, e.found.updateTime;
		const n = Oi(t, e.found.name), s = Ni(e.found.updateTime), i = e.found.createTime ? Ni(e.found.createTime) : rt.min(), r = new un({ mapValue: { fields: e.found.fields } });
...
function Qi(t, e) {
	...
	if ("targetChange" in e) {
		...
		const s = function(t) {
			...
			return t.useProto3Json ? (F(void 0 === e || "string" == typeof e), Ve.fromBase64String(e || "")) : (F(void 0 === e || e instanceof Uint8Array), Ve.fromUint8Array(e || new Uint8Array()));
		}(t, e.targetChange.resumeToken), o = e.targetChange.cause;
		n = new Ii(s, i, r, o && function(t) {
			return new U(void 0 === t.code ? q.UNKNOWN : ui(t.code), t.message || "");
		}(o) || null);
	} else if ("documentChange" in e) {
		e.documentChange;
		const s = e.documentChange;
		s.document, s.document.name, s.document.updateTime;
		const i = Oi(t, s.document.name), r = Ni(s.document.updateTime), o = s.document.createTime ? Ni(s.document.createTime) : rt.min(), u = new un({ mapValue: { fields: s.document.fields } }), c = an.newFoundDocument(i, r, o, u);
		n = new yi(s.targetIds || [], s.removedTargetIds || [], c.key, c);
	} else if ("documentDelete" in e) {
		e.documentDelete;
		const s = e.documentDelete;
		s.document;
		const i = Oi(t, s.document), r = s.readTime ? Ni(s.readTime) : rt.min(), o = an.newNoDocument(i, r);
		n = new yi([], s.removedTargetIds || [], o.key, o);
	} else if ("documentRemove" in e) {
		e.documentRemove;
		const s = e.documentRemove;
		s.document;
		const i = Oi(t, s.document);
		n = new yi([], s.removedTargetIds || [], i, null);
	} else {
...
function ji(t, e) {
	let n;
	if (e instanceof js) n = { update: Ui(t, e.key, e.value) };
	else if (e instanceof Ys) n = { delete: $i(t, e.key) };
	...
	return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map(((t) => function(t, e) {
		...
		return void 0 !== e.updateTime ? { updateTime: xi(t, e.updateTime) } : void 0 !== e.exists ? { exists: e.exists } : O();
	}(t, e.precondition)), n;
}
function zi(t, e) {
	const n = e.currentDocument ? function(t) {
		...
		let n = null;
		if ("setToServerValue" in e) F("REQUEST_TIME" === e.setToServerValue), n = new bs();
		else if ("appendMissingElements" in e) n = new Vs(e.appendMissingElements.values || []);
		else if ("removeAllFromArray" in e) n = new Ds(e.removeAllFromArray.values || []);
		else "increment" in e ? n = new xs(t, e.increment) : O();
		return new Ms(at.fromServerFormat(e.fieldPath), n);
	}(t, e))) : [];
	if (e.update) {
		e.update.name;
		const i = Oi(t, e.update.name), r = new un({ mapValue: { fields: e.update.fields } });
		if (e.updateMask) return new zs(i, r, function(t) {
			return new Re((t.fieldPaths || []).map(((t) => at.fromServerFormat(t))));
		}(e.updateMask), n, s);
		return new js(i, r, n, s);
	}
	if (e.delete) return new Ys(Oi(t, e.delete), n);
	if (e.verify) return new Xs(Oi(t, e.verify), n);
	return O();
}
function Wi(t, e) {
	return t && t.length > 0 ? (F(void 0 !== e), t.map(((t) => function(t, e) {
		let n = t.updateTime ? Ni(t.updateTime) : Ni(e);
		return n.isEqual(rt.min()) && (n = Ni(e)), new Os(n, t.transformResults || []);
	}(t, e)))) : [];
}
function Hi(t, e) {
	return { documents: [Fi(t, e.path)] };
}
function Ji(t, e) {
	const n = { structuredQuery: {} }, s = e.path;
	null !== e.collectionGroup ? (n.parent = Fi(t, s), n.structuredQuery.from = [{
		collectionId: e.collectionGroup,
		allDescendants: !0
	}]) : (n.parent = Fi(t, s.popLast()), n.structuredQuery.from = [{ collectionId: s.lastSegment() }]);
	const i = function(t) {
...
function Yi(t) {
	...
	n.orderBy && (o = n.orderBy.map(((t) => function(t) {
		return new dn(ir(t.field), function(t) {
			switch (t) {
	...
	return void 0 !== t.unaryFilter ? function(t) {
		switch (t.unaryFilter.op) {
			case "IS_NAN":
				...
				return mn.create(e, "==", { doubleValue: NaN });
			case "IS_NULL":
				const n = ir(t.unaryFilter.field);
				return mn.create(n, "==", { nullValue: "NULL_VALUE" });
			case "IS_NOT_NAN":
				const s = ir(t.unaryFilter.field);
				return mn.create(s, "!=", { doubleValue: NaN });
			case "IS_NOT_NULL":
				const i = ir(t.unaryFilter.field);
				return mn.create(i, "!=", { nullValue: "NULL_VALUE" });
			default: return O();
		}
...
function rr(t) {
	return t instanceof mn ? function(t) {
		if ("==" === t.op) {
			if (Xe(t.value)) return { unaryFilter: {
				field: sr(t.field),
				op: "IS_NAN"
			} };
			if (Ye(t.value)) return { unaryFilter: {
				field: sr(t.field),
				op: "IS_NULL"
			} };
		} else if ("!=" === t.op) {
...
* limitations under the License.
*/
/** Serializer for values stored in the LocalStore. */ var ar = class {
	constructor(t) {
		this.fe = t;
	}
};
...
function _r(t, e) {
	...
	for (let t = 0; t < e.mutations.length - 1; ++t) {
		...
		if (t + 1 < e.mutations.length && void 0 !== e.mutations[t + 1].transform) n.updateTransforms = e.mutations[t + 1].transform.fieldTransforms, e.mutations.splice(t + 1, 1), ++t;
	}
...
/** Decodes a DbTarget into TargetData */ function mr(t) {
	...
	let s;
	var i;
	return void 0 !== t.query.documents ? (F(1 === (i = t.query).documents.length), s = Jn(Gn(Bi(i.documents[0])))) : s = function(t) {
		return Jn(Yi(t));
...
var br = class {
	...
	me(t, e) {
		...
		} else "mapValue" in t ? en(t) ? this.ye(e, Number.MAX_SAFE_INTEGER) : (this.Re(t.mapValue, e), this.Ee(e)) : "arrayValue" in t ? (this.Pe(t.arrayValue, e), this.Ee(e)) : O();
	}
	Te(t, e) {
...
*/ var Dr = class {
	...
	*/ Fe(t) {
		const e = function(t) {
			const e = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(8));
...
* limitations under the License.
*/
/** Represents an index entry saved by the SDK in persisted storage. */ var kr = class kr {
	constructor(t, e, n, s) {
...
function Gr(t, e) {
	let n;
	return F(t instanceof mn || t instanceof gn), F(e instanceof mn || e instanceof gn), n = t instanceof mn ? e instanceof mn ? function(t, e) {
...
function Qr(t, e) {
	if (yn(e)) return vn(e, t.getFilters());
	{
...
*/ function jr(t) {
	...
	return n.forEach(((e) => {
		e instanceof mn ? s.push(e) : e instanceof gn && (e.op === t.op ? s.push(...e.filters) : s.push(e));
...
var Jr = class {
	constructor(t, e) {
		this.user = t, this.databaseId = e, this.on = new Wr(), this.un = new os(((t) => $n(t)), ((t, e) => On(t, e))), this.uid = t.uid || "";
	}
	/**
	...
	*/ addToCollectionParentIndex(t, e) {
	...
	getCollectionParents(t, e) {
		const n = [], s = IDBKeyRange.bound([e, ""], [st(e), ""], !1, !0);
	...
	deleteFieldIndex(t, e) {
		...
		return n.delete(e.indexId).next((() => s.delete(IDBKeyRange.bound([e.indexId], [e.indexId + 1], !1, !0)))).next((() => i.delete(IDBKeyRange.bound([e.indexId], [e.indexId + 1], !1, !0))));
	}
	getDocumentsMatchingTarget(t, e) {
		const n = Xr(t);
		let s = !0;
					...
					const u = function(t, e) {
						...
						for (const s of dt(e)) for (const e of Bn(t, s.fieldPath)) switch (e.op) {
							...
							case "in":
								...
								break;
							case "not-in":
							case "!=": return n.set(s.fieldPath.canonicalString(), e.value), Array.from(n.values());
						}
						return null;
					}(r, i), a = function(t, e) {
						const n = [];
	...
	cn(t) {
		...
		else e = Br(gn.create(t.filters, "and")).map(((e) => Mn(t.path, t.collectionGroup, t.orderBy, e.getFilters(), t.limit, t.startAt, t.endAt)));
	...
	*/ fn(t, e, n, s, i, r, o) {
		...
		for (let h = 0; h < u; ++h) {
			const u = e ? this.dn(e[h / c]) : Hr, l = this.wn(t, u, n[h % c], s), f = this._n(t, u, i[h % c], r), d = o.map(((e) => this.wn(t, u, e, !0)));
	...
	an(t, e) {
		...
		return this.getFieldIndexes(t, s).next(((t) => {
			let e = null;
			for (const s of t) n.tn(s) && (!e || s.fields.length > e.fields.length) && (e = s);
			return e;
		}));
	}
	getIndexType(t, e) {
		...
		return Rt.forEach(s, ((e) => this.an(t, e).next(((t) => {
			t ? 0 !== n && t.fields.length < function(t) {
				...
				for (const s of t.filters) for (const t of s.getFlattenedFilters()) t.field.isKeyField() || ("array-contains" === t.op || "array-contains-any" === t.op ? n = !0 : e = e.add(t.field));
	...
	*/ ln(t, e, n) {
		...
		for (const r of dt(t)) {
			const t = n[i++];
			for (const n of s) if (this.yn(e, r.fieldPath) && Je(t)) s = this.pn(s, r, t);
			else {
				const e = n.He(r.kind);
				br.Ve._e(t, e);
			}
	...
	*/ createRange(t, e, n) {
		...
		for (const i of n) {
			...
			if (0 === n) s[0] = t.Je();
			else if (n > 0 && r < 0) s.push(i), s.push(i.Je());
			else if (r > 0) break;
		}
		s.push(e);
		const i = [];
...
function io(t, e, n) {
	...
	let u = 0;
	const c = s.X({ range: o }, ((t, e, n) => (u++, n.delete())));
	r.push(c.next((() => {
		F(1 === u);
	})));
	const a = [];
...
* limitations under the License.
*/
/** A mutation queue for a specific user, backed by IndexedDB. */ so.DEFAULT_COLLECTION_PERCENTILE = 10, so.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, so.DEFAULT = new so(41943040, so.DEFAULT_COLLECTION_PERCENTILE, so.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), so.DISABLED = new so(-1, 0, 0);
var oo = class oo {
	constructor(t, e, n, s) {
	...
	*/ static de(t, e, n, s) {
		F("" !== t.uid);
		return new oo(t.isAuthenticated() ? t.uid : "", e, n, s);
	}
	checkEmpty(t) {
		let e = !0;
	...
	*/
	...
	getAllMutationBatchesAffectingDocumentKey(t, e) {
		...
		return ao(t).X({ range: s }, ((n, s, r) => {
			const [o, u, c] = n, a = Gt(u);
			if (o === this.userId && e.path.isEqual(a)) return co(t).get(c).next(((t) => {
				if (!t) throw O();
	...
	getAllMutationBatchesAffectingDocumentKeys(t, e) {
		...
		const s = [];
		return e.forEach(((e) => {
			const i = jt(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = ao(t).X({ range: r }, ((t, s, i) => {
	...
	getAllMutationBatchesAffectingQuery(t, e) {
		...
		let o = new Ee(et);
		return ao(t).X({ range: r }, ((t, e, i) => {
			const [r, u, c] = t, a = Gt(u);
			r === this.userId && n.isPrefixOf(a) ? a.length === s && (o = o.add(c)) : i.done();
		})).next((() => this.Dn(t, o)));
	}
	Dn(t, e) {
		const n = [], s = [];
...
*/ var fo = class {
	...
	allocateTargetId(t) {
		return this.$n(t).next(((e) => {
			return e.highestTargetId = new lo(e.highestTargetId).next(), this.On(t, e).next((() => e.highestTargetId));
		}));
	}
	...
	*/ Bn(t, e) {
	...
	removeMatchingKeysForTargetId(t, e) {
		const n = mo(t), s = IDBKeyRange.bound([e], [e + 1], !1, !0);
		return n.delete(s);
	}
	getMatchingKeysForTargetId(t, e) {
		const n = IDBKeyRange.bound([e], [e + 1], !1, !0), s = mo(t);
		let i = gs();
		return s.X({
			range: n,
			Y: !0
		}, ((t, e, n) => {
			const r = new ht(Gt(t[1]));
			i = i.add(r);
		})).next((() => i));
	}
	containsKey(t, e) {
		const n = qt(e.path), s = IDBKeyRange.bound([n], [st(n)], !1, !0);
		let i = 0;
		return mo(t).X({
...
*/ var Io = class {
	...
	Hn(t, e) {
		...
		return this.calculateTargetCount(t, this.params.percentileToCollect).next(((e) => (e > this.params.maximumSequenceNumbersToCollect ? (N("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`), s = this.params.maximumSequenceNumbersToCollect) : s = e, r = Date.now(), this.nthSequenceNumber(t, s)))).next(((s) => (n = s, o = Date.now(), this.removeTargets(t, n, e)))).next(((e) => (i = e, c = Date.now(), this.removeOrphanedDocuments(t, n)))).next(((t) => {
			if (a = Date.now(), C() <= LogLevel.DEBUG) N("LruGarbageCollector", `LRU Garbage Collection\n\tCounted targets in ${r - h}ms\n\tDetermined least recently used ${s} in ` + (o - r) + `ms
...
* limitations under the License.
*/
/** Provides LRU functionality for IndexedDB persistence. */ var Eo = class {
	constructor(t, e) {
		...
		return this.Yn(t, ((r, o) => {
			if (o <= e) {
				const e = this.Xn(t, r).next(((e) => {
					if (!e) return i++, n.getEntry(t, r).next((() => (n.removeEntry(r, rt.min()), mo(t).delete([0, qt(r.path)]))));
				}));
				s.push(e);
			}
	...
	*/ Yn(t, e) {
		const n = mo(t);
		let s, i = Ot.ct;
		return n.X({ index: "documentTargetsIndex" }, (([t, n], { path: r, sequenceNumber: o }) => {
			0 === t ? (i !== Ot.ct && e(new ht(Gt(s)), i), i = o, s = r) : i = Ot.ct;
		})).next((() => {
	...
	*/ ss(t, e) {
	...
	ns(t, e, n) {
		...
		return So(t).X({
			...
			const i = ht.fromSegments([
				...e.prefixPath,
				e.collectionGroup,
				e.documentId
			]);
			for (; o && xo(o, i) < 0;) n(o, null), o = r.getNext();
			o && o.isEqual(i) && (n(o, e), o = r.hasNext() ? r.getNext() : null), o ? s.G(Do(o)) : s.done();
		})).next((() => {
	...
	getDocumentsMatchingQuery(t, e, n, s) {
		...
		return So(t).j(IDBKeyRange.bound(r, o, !0)).next(((t) => {
			...
			for (const i of t) {
				...
				t.isFoundDocument() && (ns(e, t) || s.has(t.key)) && (n = n.insert(t.key, t));
			}
			return n;
		}));
	}
...
*/ var bo = class extends vo {
	...
	*/
	constructor(t, e) {
		super(), this.os = t, this.trackRemovals = e, this.us = new os(((t) => t.toString()), ((t, e) => t.isEqual(e)));
	}
	applyChanges(t) {
		const e = [];
	...
	getAllFromCache(t, e) {
		return this.os.ss(t, e).next((({ documents: t, rs: e }) => (e.forEach(((e, n) => {
			this.us.set(e, {
				size: n,
...
*/ var ko = class {
	...
	*/ computeViews(t, e, n, s) {
		...
		return e.forEach(((t, e) => {
			const o = n.get(e.key);
			s.has(e.key) && (void 0 === o || o.mutation instanceof zs) ? i = i.insert(e.key, e) : void 0 !== o ? (r.set(e.key, o.mutation.getFieldMask()), Ks(o.mutation, e, o.mutation.getFieldMask(), it.now())) : r.set(e.key, Re.empty());
	...
	getDocumentsMatchingCollectionGroupQuery(t, e, n) {
		...
		return this.indexManager.getCollectionParents(t, s).next(((r) => Rt.forEach(r, ((r) => {
			const o = function(t, e) {
				return new Un(e, null, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, t.endAt);
			}(e, r.child(s));
	...
	getDocumentsMatchingCollectionQuery(t, e, n) {
		...
		return this.documentOverlayCache.getOverlaysForCollection(t, e.path, n.largestBatchId).next(((i) => (s = i, this.remoteDocumentCache.getDocumentsMatchingQuery(t, e, n, s)))).next(((t) => {
			...
			return t.forEach(((t, i) => {
				const r = s.get(t);
				void 0 !== r && Ks(r.mutation, i, Re.empty(), it.now()), ns(e, i) && (n = n.insert(t, i));
			})), n;
		}));
	}
};
...
*/ var $o = class {
	...
	getOverlaysForCollectionGroup(t, e, n, s) {
		...
		for (; u.hasNext();) if (u.getNext().value.forEach(((t, e) => o.set(t, e))), o.size() >= s) break;
		return Rt.resolve(o);
	}
	we(t, e, n) {
...
*/ var Bo = class {
	...
	getAllMutationBatchesAffectingQuery(t, e) {
		...
		return this.Rs.forEachWhile(((t) => {
			const e = t.key.path;
			return !!n.isPrefixOf(e) && (e.length === s && (o = o.add(t.As)), !0);
...
*/ var Uo = class {
	constructor(t) {
		this.persistence = t, this.xs = new os(((t) => $n(t)), On), this.lastRemoteSnapshotVersion = rt.min(), this.highestTargetId = 0, this.Ns = 0, this.ks = new Oo(), this.targetCount = 0, this.Ms = lo.kn();
	}
	forEachTarget(t, e) {
...
var Qo = class Qo {
	...
	Hs(t, e) {
		return Rt.or([
			() => Rt.resolve(this.Qs.containsKey(e)),
			() => this.persistence.getTargetCache().containsKey(t, e),
			() => this.persistence.Gs(t, e)
		]);
	}
};
var jo = class jo {
...
* limitations under the License.
*/
/** Performs database creation and schema upgrades. */ var zo = class {
	constructor(t) {
		this.serializer = t;
	}
	/**
	...
	*/ O(t, e, n, s) {
		...
		n < 1 && s >= 1 && (function(t) {
			...
			t.createObjectStore("mutations", {
				keyPath: "batchId",
				autoIncrement: !0
			}).createIndex("userMutationsIndex", Qt, { unique: !0 }), t.createObjectStore("documentMutations");
		}(t), Wo(t), function(t) {
		...
		return n < 3 && s >= 3 && (0 !== n && (function(t) {
		...
		}(i)))), n < 4 && s >= 4 && (0 !== n && (r = r.next((() => function(t, e) {
			return e.store("mutations").j().next(((n) => {
				t.deleteObjectStore("mutations");
				t.createObjectStore("mutations", {
					keyPath: "batchId",
					autoIncrement: !0
				}).createIndex("userMutationsIndex", Qt, { unique: !0 });
			...
			(function(t) {
				const e = t.createObjectStore("documentOverlays", { keyPath: oe });
				e.createIndex("collectionPathOverlayIndex", ue, { unique: !1 }), e.createIndex("collectionGroupOverlayIndex", ce, { unique: !1 });
			})(t);
		}))), n < 13 && s >= 13 && (r = r.next((() => function(t) {
			const e = t.createObjectStore("remoteDocumentsV14", { keyPath: Ht });
			...
			t.createObjectStore("indexState", { keyPath: ne }).createIndex("sequenceNumberIndex", se, { unique: !1 });
			t.createObjectStore("indexEntries", { keyPath: ie }).createIndex("documentKeyIndex", re, { unique: !1 });
		}(t)))), r;
	}
	Xs(t) {
		let e = 0;
	...
	*/ Zs(t) {
	...
	ti(t, e) {
		t.createObjectStore("collectionParents", { keyPath: ee });
		...
		return e.store("remoteDocuments").X({ Y: !0 }, ((t, e) => {
			return i(new ut(t).popLast());
		})).next((() => e.store("documentMutations").X({ Y: !0 }, (([t, e, n], s) => {
			return i(Gt(e).popLast());
		}))));
	}
	ei(t) {
	...
	si(t, e) {
		...
		return n.j().next(((t) => {
			...
			return t.forEach(((t) => {
				...
				const r = new V(n), o = Rr.de(this.serializer, r), u = i.getIndexManager(r);
				return new ko(s, oo.de(r, this.serializer, u, i.referenceDelegate), o, u).recalculateAndSaveOverlaysForDocumentKeys(new we(e, Ot.ct), t).next();
			}));
		}));
	}
};
function Wo(t) {
	t.createObjectStore("targetDocuments", { keyPath: Zt }).createIndex("documentTargetsIndex", te, { unique: !0 });
	t.createObjectStore("targets", { keyPath: "targetId" }).createIndex("queryTargetsIndex", Xt, { unique: !0 }), t.createObjectStore("targetGlobal");
}
...
var Jo = class Jo {
	constructor(t, e, n, s, i, r, o, u, c, a, h = 15) {
		if (this.allowTabSynchronization = t, this.persistenceKey = e, this.clientId = n, this.ii = i, this.window = r, this.document = o, this.ri = c, this.oi = a, this.ui = h, this.Os = null, this.Fs = !1, this.isPrimary = !1, this.networkEnabled = !0, this.ci = null, this.inForeground = !1, this.ai = null, this.hi = null, this.li = Number.NEGATIVE_INFINITY, this.fi = (t) => Promise.resolve(), !Jo.D()) throw new U(q.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
	...
	*/ start() {
		return this.mi().then((() => {
			if (!this.isPrimary && !this.allowTabSynchronization) throw new U(q.FAILED_PRECONDITION, Ho);
	...
	*/ mi() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((t) => Xo(t).put({
			...
			if (Dt(t)) return N("IndexedDbPersistence", "Failed to extend owner lease: ", t), this.isPrimary;
	...
	*/ Ei(t) {
		...
		return Yo(t).get("owner").next(((e) => {
			if (null !== e && this.Vi(e.leaseTimestampMs, 5e3) && !this.Ci(e.ownerId)) {
				...
				if (!this.Ri(e)) {
					if (!e.allowTabSynchronization) throw new U(q.FAILED_PRECONDITION, Ho);
					return !1;
				}
			}
	...
	async shutdown() {
		this.Fs = !1, this.xi(), this.hi && (this.hi.cancel(), this.hi = null), this.Ni(), this.ki(), await this.wi.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], ((t) => {
	...
	*/ yi() {
		...
		"function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ci = () => {
			...
			isSafari() && (navigator.appVersion.match(t) || navigator.userAgent.match(t)) && this.ii.enterRestrictedMode(!0), this.ii.enqueueAndForget((() => this.shutdown()));
...
*/ var eu = class {
	...
	*/ Ki(t, e) {
		if (Qn(e)) return Rt.resolve(null);
		let n = Jn(e);
		return this.indexManager.getIndexType(t, n).next(((s) => 0 === s ? null : (null !== e.limit && 1 === s && (e = Xn(e, null, "F"), n = Jn(e)), this.indexManager.getDocumentsMatchingTarget(t, n).next(((s) => {
			const i = gs(...s);
	...
	*/ Wi(t, e, n, s) {
		return this.Ui.getDocumentsMatchingQuery(t, n, s).next(((t) => (e.forEach(((e) => {
			t = t.insert(e.key, e);
		})), t)));
	}
};
...
var nu = class {
	constructor(t, e, n, s) {
		this.persistence = t, this.Hi = e, this.serializer = s, this.Ji = new pe(et), this.Yi = new os(((t) => $n(t)), On), this.Xi = /* @__PURE__ */ new Map(), this.Zi = t.getRemoteDocumentCache(), this.Bs = t.getTargetCache(), this.qs = t.getBundleCache(), this.tr(n);
	}
	tr(t) {
...
function ru(t, e) {
	...
	return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", ((t) => {
		const s = e.batch.keys(), i = n.Zi.newChangeBuffer({ trackRemovals: !0 });
		return function(t, e, n, s) {
			...
			return r.forEach(((t) => {
				o = o.next((() => s.getEntry(e, t))).next(((e) => {
					...
					F(null !== r), e.version.compareTo(r) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && (e.setReadTime(n.commitVersion), s.addEntry(e)));
				}));
...
*/ function uu(t, e) {
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((t) => {
		const r = n.Zi.newChangeBuffer({ trackRemovals: !0 });
		i = n.Ji;
		const o = [];
		e.targetChanges.forEach(((r, u) => {
			...
			null !== e.targetMismatches.get(u) ? a = a.withResumeToken(Ve.EMPTY_BYTE_STRING, rt.min()).withLastLimboFreeSnapshotVersion(rt.min()) : r.resumeToken.approximateByteSize() > 0 && (a = a.withResumeToken(r.resumeToken, s)), i = i.insert(u, a), function(t, e, n) {
...
*/ function cu(t, e, n) {
	...
	return n.forEach(((t) => s = s.add(t))), e.getEntries(t, s).next(((t) => {
		...
		return n.forEach(((n, r) => {
			const o = t.get(n);
			r.isFoundDocument() !== o.isFoundDocument() && (i = i.add(n)), r.isNoDocument() && r.version.isEqual(rt.min()) ? (e.removeEntry(n, r.readTime), s = s.insert(n, r)) : !o.isValidDocument() || r.version.compareTo(o.version) > 0 || 0 === r.version.compareTo(o.version) && o.hasPendingWrites ? (e.addEntry(r), s = s.insert(n, r)) : N("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", o.version, " Watch version:", r.version);
		})), {
			nr: s,
			sr: i
		};
...
function hu(t, e) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((t) => {
		let s;
		return n.Bs.getTargetData(t, e).next(((i) => i ? (s = i, Rt.resolve(s)) : n.Bs.allocateTargetId(t).next(((i) => (s = new cr(e, i, "TargetPurposeListen", t.currentSequenceNumber), n.Bs.addTargetData(t, s).next((() => s)))))));
	})).then(((t) => {
...
function wu(t, e) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((t) => n.Zi.getAllFromCollectionGroup(t, e, yt(s, -1), Number.MAX_SAFE_INTEGER))).then(((t) => (_u(n, e, t), t)));
}
...
async function mu(t, e, n, s) {
	...
	const u = i.Zi.newChangeBuffer({ trackRemovals: !0 }), c = await hu(i, function(t) {
...
var Tu = class Tu {
	...
	*/ static ar(t, e, n) {
		...
		return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new U(s.error.code, s.error.message))), r ? new Tu(t, e, s.state, i) : (k("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
	}
	hr() {
		const t = {
			state: this.state,
...
*/ var Au = class Au {
	...
	*/ static ar(t, e) {
		...
		for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = Lt(n.activeTargetIds[t]), i = i.add(n.activeTargetIds[t]);
...
*/ var vu = class vu {
	...
	*/ static ar(t) {
		...
		return "object" == typeof e && -1 !== [
			...
			"Online",
			"Offline"
		].indexOf(e.onlineState) && "string" == typeof e.clientId ? new vu(e.clientId, e.onlineState) : (k("SharedClientState", `Failed to parse online state: ${t}`), null);
	}
};
/**
...
*/ var Pu = class {
	constructor(t, e, n, s, i) {
		this.window = t, this.ii = e, this.persistenceKey = n, this.wr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this._r = this.mr.bind(this), this.gr = new pe(et), this.started = !1, this.yr = [];
		const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.pr = yu(this.persistenceKey, this.wr), this.Ir = function(t) {
			return `firestore_sequence_number_${t}`;
		}(this.persistenceKey), this.gr = this.gr.insert(this.wr, new Ru()), this.Tr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.Er = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.Ar = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.vr = function(t) {
			/**
			* @license
			* Copyright 2018 Google LLC
			*
...
var Mu = class extends class {
	...
	Io(t, e, n, s, i) {
		...
		const u = {};
		return this.Eo(u, s, i), this.Ao(t, o, u, n).then(((e) => (N("RestConnection", `Received RPC '${t}' ${r}: `, e), e)), ((e) => {
			throw M("RestConnection", `RPC '${t}' ${r} failed with error: `, e, "url: ", o, "request:", n), e;
		}));
	}
	vo(t, e, n, s, i, r) {
	...
	*/ Eo(t, e, n) {
		t["X-Goog-Api-Client"] = "gl-js/ fire/" + S, t["Content-Type"] = "text/plain", this.databaseInfo.appId && (t["X-Firebase-GMPID"] = this.databaseInfo.appId), e && e.headers.forEach(((e, n) => t[n] = e)), n && n.headers.forEach(((e, n) => t[n] = e));
	}
	To(t, e) {
		const n = xu[t];
	...
	Ro(t, e, n) {
		const s = Cu(), i = [
			...
			t,
			"/channel"
		], r = createWebChannelTransport(), o = getStatEventTarget(), u = {
		...
		void 0 !== c && (u.longPollingTimeout = Math.round(1e3 * c)), this.useFetchStreams && (u.xmlHttpFactory = new FetchXmlHttpFactory({})), this.Eo(u.initMessageHeaders, e, n), u.encodeInitMessageHeaders = !0;
		const a = i.join("");
		...
		const d = new Nu({
			ro: (e) => {
				f ? N(ku, `Not sending because RPC '${t}' stream ${s} is closed:`, e) : (l || (N(ku, `Opening RPC '${t}' stream ${s} transport.`), h.open(), l = !0), N(ku, `RPC '${t}' stream ${s} sending:`, e), h.send(e));
			},
			oo: () => h.close()
		}), w = (t, e, n) => {
			t.listen(e, ((t) => {
		...
		return w(h, WebChannel.EventType.OPEN, (() => {
			...
			if (!f) {
				...
				if (o) {
					...
					void 0 === n && (n = q.INTERNAL, i = "Unknown error status: " + e + " with message " + o.message), f = !0, d.wo(new U(n, i)), h.close();
...
var Lu = class {
	constructor(t, e, n, s, i, r, o, u) {
		this.ii = t, this.$o = n, this.Oo = s, this.connection = i, this.authCredentialsProvider = r, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, this.Fo = 0, this.Bo = null, this.Lo = null, this.stream = null, this.qo = new Bu(t, e);
	}
	/**
...
*/ var qu = class extends Lu {
	...
	*/ su(t) {
		...
		e.database = Li(this.serializer), e.addTarget = function(t, e) {
			let n;
			const s = e.target;
			if (n = Fn(s) ? { documents: Hi(t, s) } : { query: Ji(t, s) }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0) {
...
*/ var Uu = class extends Lu {
	constructor(t, e, n, s, i, r) {
		super(t, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", e, n, s, r), this.serializer = i, this.ru = !1;
	}
	/**
...
var Ku = class extends class {} {
	constructor(t, e, n, s) {
		super(), this.authCredentials = t, this.appCheckCredentials = e, this.connection = n, this.serializer = s, this.lu = !1;
	}
	fu() {
	...
	/** Invokes the provided RPC with auth and AppCheck tokens. */ Io(t, e, n) {
		return this.fu(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then((([s, i]) => this.connection.Io(t, e, n, s, i))).catch(((t) => {
			throw "FirebaseError" === t.name ? (t.code === q.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t) : new U(q.UNKNOWN, t.toString());
		}));
	}
	...
	const i = L(t), { request: r, du: o } = function(t, e, n) {
		...
		return n.forEach(((t) => {
			...
			i[e] = t.alias, "count" === t.yt ? r.push({
				...
				alias: e,
				avg: { field: sr(t.fieldPath) }
			}) : "sum" === t.yt && r.push({
				alias: e,
				sum: { field: sr(t.fieldPath) }
			});
		})), {
			request: {
...
var Qu = class {
	constructor(t, e) {
		this.asyncQueue = t, this.onlineStateHandler = e, this.state = "Unknown", this.wu = 0, this._u = null, this.mu = !0;
	}
	/**
	...
	*/ set(t) {
		this.Tu(), this.wu = 0, "Online" === t && (this.mu = !1), this.yu(t);
	}
	yu(t) {
...
*/ var ju = class {
	constructor(t, e, n, s, i) {
		this.localStore = t, this.datastore = e, this.asyncQueue = n, this.remoteSyncer = {}, this.Eu = [], this.Au = /* @__PURE__ */ new Map(), this.vu = /* @__PURE__ */ new Set(), this.Ru = [], this.Pu = i, this.Pu.Yr(((t) => {
			n.enqueueAndForget((async () => {
				ec(this) && (N("RemoteStore", "Restarting streams for network reachability change."), await async function(t) {
					const e = L(t);
					e.vu.add(4), await Wu(e), e.bu.set("Unknown"), e.vu.delete(4), await zu(e);
				}(this));
			}));
		})), this.bu = new Qu(n, s);
	}
...
async function rc(t, e, n) {
	if (t.bu.set("Online"), e instanceof Ii && 2 === e.state && e.cause) try {
		await async function(t, e) {
			const n = e.cause;
			for (const s of e.targetIds) t.Au.has(s) && (await t.remoteSyncer.rejectListen(s, n), t.Au.delete(s), t.Vu.removeTarget(s));
		}(t, e);
	} catch (n) {
		N("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), await oc(t, n);
	}
		...
		n.compareTo(e) >= 0 && await function(t, e) {
			...
			return n.targetChanges.forEach(((n, s) => {
				...
				const s = t.Au.get(e);
				if (!s) return;
				t.Au.set(e, s.withResumeToken(Ve.EMPTY_BYTE_STRING, s.snapshotVersion)), Xu(t, e);
				Yu(t, new cr(s.target, e, n, s.sequenceNumber));
...
async function mc(t, e) {
	e && Ic(t).ou && await async function(t, e) {
		if (n = e.code, oi(n) && n !== q.ABORTED) {
			const n = t.Eu.shift();
			Ic(t).Qo(), await uc(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), await cc(t);
		}
		var n;
	}(t, e), lc(t) && fc(t);
}
...
*/ function pc(t) {
	return t.Su || (t.Su = function(t, e, n) {
		const s = L(t);
...
* This is not done on Web to allow it to be tree-shaken.
*/ function Ic(t) {
	return t.Du || (t.Du = function(t, e, n) {
		const s = L(t);
...
var Tc = class Tc {
	constructor(t, e, n, s, i) {
		this.asyncQueue = t, this.timerId = e, this.targetTimeMs = n, this.op = s, this.removalCallback = i, this.deferred = new K(), this.then = this.deferred.promise.then.bind(this.deferred.promise), this.deferred.promise.catch(((t) => {}));
	}
	/**
	...
	*/ static createAndSchedule(t, e, n, s, i) {
		const o = new Tc(t, e, Date.now() + n, s, i);
		return o.start(n), o;
	}
	/**
...
*/ var Ac = class Ac {
	...
	constructor(t) {
		this.comparator = t ? (e, n) => t(e, n) || ht.comparator(e.key, n.key) : (t, e) => ht.comparator(t.key, e.key), this.keyedMap = hs(), this.sortedSet = new pe(this.comparator);
	}
	/**
...
var Rc = class Rc {
	...
	/** Returns a view snapshot as if all documents in the snapshot were added. */ static fromInitialDocuments(t, e, n, s, i) {
		...
		})), new Rc(t, e, Ac.emptySet(e), r, n, s, !0, !1, i);
	}
	get hasPendingWrites() {
...
async function Vc(t, e) {
	...
	if (n.queries.set(s, r), r.listeners.push(e), e.Mu(n.onlineState), r.Nu) e.$u(r.Nu) && xc(n);
}
...
*/ var Nc = class {
	constructor(t, e, n) {
		this.query = t, this.Ou = e, this.Fu = !1, this.Bu = null, this.onlineState = "Unknown", this.options = n || {};
	}
	/**
	...
	*/ $u(t) {
		if (!this.options.includeMetadataChanges) {
			...
			t = new Rc(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, !0, t.hasCachedResults);
		}
		let e = !1;
		return this.Fu ? this.Lu(t) && (this.Ou.next(t), e = !0) : this.qu(t, this.onlineState) && (this.Uu(t), e = !0), this.Bu = t, e;
	}
	onError(t) {
		this.Ou.error(t);
	}
	/** Returns whether a snapshot was raised. */ Mu(t) {
		this.onlineState = t;
		let e = !1;
		return this.Bu && !this.Fu && this.qu(this.Bu, t) && (this.Uu(this.Bu), e = !0), e;
	}
	qu(t, e) {
	...
	Uu(t) {
		t = Rc.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache, t.hasCachedResults), this.Fu = !0, this.Ou.next(t);
	}
};
/**
* @license
...
*/ var $c = class {
	...
	*/ zu(t) {
		...
		if (t.Gu.namedQuery) this.queries.push(t.Gu.namedQuery);
			...
			this.documents.push({ metadata: t.Gu.documentMetadata }), t.Gu.documentMetadata.exists || ++e;
...
*/ var Lc = class {
	constructor(t, e) {
		this.query = t, this.Yu = e, this.Xu = null, this.hasCachedResults = !1, this.current = !1, this.Zu = gs(), this.mutatedKeys = gs(), this.tc = is(t), this.ec = new Ac(this.tc);
	}
	/**
	...
	*/ sc(t, e) {
		...
		if (t.inorderTraversal(((t, e) => {
			const a = s.get(t), h = ns(this.query, e) ? e : null, l = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || this.mutatedKeys.has(h.key) && h.hasCommittedMutations);
			let d = !1;
			if (a && h) a.data.isEqual(h.data) ? l !== f && (n.track({
				...
				type: 2,
				doc: h
			}), d = !0, (u && this.tc(h, u) > 0 || c && this.tc(h, c) < 0) && (o = !0));
			else !a && h ? (n.track({
				type: 0,
				doc: h
			}), d = !0) : a && !h && (n.track({
	...
	*/
	applyChanges(t, e, n) {
		...
		*/
		...
		if (this.Xu = o, 0 !== i.length || u) return {
			snapshot: new Rc(this.query, t.ec, s, i, t.mutatedKeys, 0 === o, u, !1, !!n && n.resumeToken.approximateByteSize() > 0),
			cc: r
		};
		return { cc: r };
	}
	...
	*/ oc(t) {
		t && (t.addedDocuments.forEach(((t) => this.Yu = this.Yu.add(t))), t.modifiedDocuments.forEach(((t) => {})), t.removedDocuments.forEach(((t) => this.Yu = this.Yu.delete(t))), this.current = t.current);
	}
	uc() {
...
/** Tracks a limbo resolution. */ var Uc = class {
	constructor(t) {
		this.key = t, this.fc = !1;
	}
};
/**
...
*/ var Kc = class {
	constructor(t, e, n, s, i, r) {
		this.localStore = t, this.remoteStore = e, this.eventManager = n, this.sharedClientState = s, this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.dc = {}, this.wc = new os(((t) => ts(t)), Zn), this._c = /* @__PURE__ */ new Map(), this.mc = /* @__PURE__ */ new Set(), this.gc = new pe(ht.comparator), this.yc = /* @__PURE__ */ new Map(), this.Ic = new Oo(), this.Tc = {}, this.Ec = /* @__PURE__ */ new Map(), this.Ac = lo.Mn(), this.onlineState = "Unknown", this.vc = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.vc;
	}
...
async function Gc(t, e) {
	...
	let s, i;
	const r = n.wc.get(e);
	if (r) s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.lc();
	else {
...
*/ async function Qc(t, e, n, s, i) {
	t.Rc = (e, n, s) => async function(t, e, n, s) {
		let i = e.view.sc(n);
		i.zi && (i = await fu(t.localStore, e.query, !1).then((({ documents: t }) => e.view.sc(t, i))));
	...
	const r = await fu(t.localStore, e, !0), o = new Lc(e, r.ir), u = o.sc(r.documents), c = gi.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t.onlineState, i), a = o.applyChanges(u, t.isPrimaryClient, c);
	ia(t, n, a.cc);
...
/** Stops listening to the query. */ async function jc(t, e) {
	...
	if (n.isPrimaryClient) {
		...
		n.sharedClientState.isActiveQueryTarget(s.targetId) || await lu(n.localStore, s.targetId, !1).then((() => {
			n.sharedClientState.clearQueryState(s.targetId), Ju(n.remoteStore, s.targetId), na(n, s.targetId);
		})).catch(vt);
	} else na(n, s.targetId), await lu(n.localStore, s.targetId, !0);
}
/**
			...
			return n.persistence.runTransaction("Locally write mutations", "readwrite", ((t) => {
				...
				return n.Zi.getEntries(t, i).next(((t) => {
					...
					for (const t of e) {
						...
						null != e && o.push(new zs(t.key, e, cn(e.value.mapValue), Fs.exists(!0)));
					}
...
*/ async function Wc(t, e) {
	...
	try {
		...
		e.targetChanges.forEach(((t, e) => {
			const s = n.yc.get(e);
			s && (F(t.addedDocuments.size + t.modifiedDocuments.size + t.removedDocuments.size <= 1), t.addedDocuments.size > 0 ? s.fc = !0 : t.modifiedDocuments.size > 0 ? F(s.fc) : t.removedDocuments.size > 0 && (F(s.fc), s.fc = !1));
		})), await ua(n, t, e);
	} catch (t) {
		await vt(t);
	}
	...
	if (s.isPrimaryClient && 0 === n || !s.isPrimaryClient && 1 === n) {
		...
		s.wc.forEach(((n, s) => {
			...
			n.queries.forEach(((t, n) => {
				for (const t of n.listeners) t.Mu(e) && (s = !0);
			})), s && xc(n);
...
*/ async function Jc(t, e, n) {
	...
	if (r) {
		...
		const n = gs().add(r);
		await Wc(s, new mi(rt.min(), /* @__PURE__ */ new Map(), new pe(et), t, n)), s.gc = s.gc.remove(r), s.yc.delete(e), oa(s);
	} else await lu(s.localStore, e, !1).then((() => na(s, e, n))).catch(vt);
}
async function Yc(t, e) {
	const n = L(t), s = e.batch.batchId;
	try {
		const t = await ru(n.localStore, e);
		ea(n, s, null), ta(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await ua(n, t);
	} catch (t) {
		await vt(t);
	}
}
	...
	try {
		const t = await function(t, e) {
			...
			return n.persistence.runTransaction("Reject batch", "readwrite-primary", ((t) => {
				let s;
				return n.mutationQueue.lookupMutationBatch(t, e).next(((e) => (F(null !== e), s = e.keys(), n.mutationQueue.removeMutationBatch(t, e)))).next((() => n.mutationQueue.performConsistencyCheck(t))).next((() => n.documentOverlayCache.removeOverlaysForBatchId(t, s, e))).next((() => n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t, s))).next((() => n.localDocuments.getDocuments(t, s)));
			}));
		}(s.localStore, e);
		ea(s, e, n), ta(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), await ua(s, t);
	} catch (n) {
		await vt(n);
	}
}
...
function na(t, e, n = null) {
	...
	if (t._c.delete(e), t.isPrimaryClient) t.Ic.Is(e).forEach(((e) => {
		t.Ic.containsKey(e) || sa(t, e);
	}));
}
function sa(t, e) {
...
function ia(t, e, n) {
	for (const s of n) if (s instanceof Fc) t.Ic.addReference(s.key, e), ra(t, s);
...
async function ua(t, e, n) {
	...
	s.wc.isEmpty() || (s.wc.forEach(((t, u) => {
		o.push(s.Rc(u, e, n).then(((t) => {
			if ((t || n) && s.isPrimaryClient && s.sharedClientState.updateQueryState(u.targetId, (null == t ? void 0 : t.fromCache) ? "not-current" : "current"), t) {
				i.push(t);
...
async function ca(t, e) {
	...
	if (!n.currentUser.isEqual(e)) {
		...
		}(n, "'waitForPendingWrites' promise is rejected due to a user change."), n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await ua(n, t.er);
	}
}
function aa(t, e) {
...
*/ async function ha(t, e) {
	const n = L(t), s = await fu(n.localStore, e.query, !0), i = e.view.hc(s);
...
async function fa(t, e, n, s) {
	...
	null !== r ? ("pending" === n ? await cc(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (ea(i, e, s || null), ta(i, e), function(t, e) {
		L(L(t).mutationQueue).Cn(e);
	}(i.localStore, e)) : O(), await ua(i, r)) : N("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
/** Applies a query target change from a different tab. */
async function da(t, e) {
	const n = L(t);
	if (pa(n), Ia(n), !0 === e && !0 !== n.vc) {
		const e = await wa(n, n.sharedClientState.getAllActiveQueryTargets().toArray());
		...
		n._c.forEach(((s, i) => {
			n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (na(n, i), lu(n.localStore, i, !0)))), Ju(n.remoteStore, i);
		})), await e, await wa(n, t), function(t) {
			const e = L(t);
			e.yc.forEach(((t, n) => {
				Ju(e.remoteStore, n);
			})), e.Ic.Ts(), e.yc = /* @__PURE__ */ new Map(), e.gc = new pe(ht.comparator);
...
async function wa(t, e, n) {
	...
	for (const t of e) {
		...
		if (n && 0 !== n.length) {
			...
			for (const t of n) {
				const n = await ha(s, s.wc.get(t));
				n.snapshot && r.push(n.snapshot);
			}
		} else {
			const n = await du(s.localStore, t);
			e = await hu(s.localStore, n), await Qc(s, _a(n), t, !1, e.resumeToken);
		}
		i.push(e);
	}
	return s.dc.nu(r), i;
...
function ma(t) {
	return L(L(L(t).localStore).persistence).$i();
}
/** Applies a query target change from a different tab. */
async function ga(t, e, n, s) {
	const i = L(t);
	if (i.vc) return void N("SyncEngine", "Ignoring unexpected query state notification.");
	const r = i._c.get(e);
	if (r && r.length > 0) switch (n) {
		case "current":
		case "not-current":
			await ua(i, await wu(i.localStore, ss(r[0])), mi.createSynthesizedRemoteEventForCurrentChange(e, "current" === n, Ve.EMPTY_BYTE_STRING));
			break;
		case "rejected":
			await lu(i.localStore, e, !0), na(i, e, s);
			break;
		default: O();
	}
}
/** Adds or removes Watch targets for queries from different tabs. */ async function ya(t, e, n) {
	...
	if (s.vc) {
		for (const t of e) {
			...
			await Qc(s, _a(e), n.targetId, !1, n.resumeToken), Hu(s.remoteStore, n);
		}
		for (const t of n) s._c.has(t) && await lu(s.localStore, t, !1).then((() => {
...
async function(t, e, n) {
		try {
			...
			}(s)), Promise.resolve(/* @__PURE__ */ new Set());
			...
			return await ua(t, o.Ju, void 0), await function(t, e) {
				const n = L(t);
			...
			return M("SyncEngine", `Loading bundle failed with ${t}`), n._failWith(t), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(s, e, n).then(((t) => {
		/**
		* @license
...
*/ var Ra = class extends va {
	...
	async initialize(t) {
		...
		this.sharedClientState instanceof Pu && (this.sharedClientState.syncEngine = {
			...
			$i: ma.bind(null, e),
			Qr: la.bind(null, e)
		}, await this.sharedClientState.start()), await this.persistence.Ii((async (t) => {
			await da(this.Vc.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start() : t || this.gcScheduler.stop()), this.indexBackfillerScheduler && (t && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : t || this.indexBackfillerScheduler.stop());
		}));
	}
	createSharedClientState(t) {
		const e = $u();
...
*/ var Pa = class {
	async initialize(t, e) {
		this.localStore || (this.localStore = t.localStore, this.sharedClientState = t.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(e, !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = (t) => Hc(this.syncEngine, t, 1), this.remoteStore.remoteSyncer.handleCredentialChange = ca.bind(null, this.syncEngine), await yc(this.remoteStore, this.syncEngine.isPrimaryClient));
	}
	...
	createRemoteStore(t) {
		return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = (t) => Hc(this.syncEngine, t, 0), r = Su.D() ? new Su() : new Vu(), new ju(e, n, s, i, r);
		var e, n, s, i, r;
...
*/ var Sa = class {
	constructor(t, e) {
		this.Cc = t, this.serializer = e, this.metadata = new K(), this.buffer = new Uint8Array(), this.xc = new TextDecoder("utf-8"), this.Nc().then(((t) => {
			t && t.Qu() ? this.metadata.resolve(t.Gu.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(null == t ? void 0 : t.Gu)}`));
	...
	*/ async $c(t) {
		for (; this.buffer.length < t;) await this.Fc() && this.Mc("Reached the end of bundle when more is expected.");
		const e = this.xc.decode(this.buffer.slice(0, t));
		return this.buffer = this.buffer.slice(t), e;
	}
	Mc(t) {
		throw this.Cc.cancel(), /* @__PURE__ */ new Error(`Invalid bundle format: ${t}`);
	}
	/**
...
var Da = class {
	constructor(t) {
		this.datastore = t, this.readVersions = /* @__PURE__ */ new Map(), this.mutations = [], this.committed = !1, this.lastWriteError = null, this.writtenDocs = /* @__PURE__ */ new Set();
	}
	async lookup(t) {
		...
		const e = await async function(t, e) {
			const n = L(t), s = Li(n.serializer) + "/documents", i = { documents: e.map(((t) => $i(n.serializer, t))) }, r = await n.vo("BatchGetDocuments", s, i, e.length), o = /* @__PURE__ */ new Map();
			r.forEach(((t) => {
	...
	async commit() {
		...
		this.mutations.forEach(((e) => {
			...
			const n = L(t), s = Li(n.serializer) + "/documents", i = { writes: e.map(((t) => ji(n.serializer, t))) };
	...
	recordVersion(t) {
		...
		if (n) {
			if (!e.isEqual(n)) throw new U(q.ABORTED, "Document version changed between two reads.");
	...
	*/ preconditionForUpdate(t) {
		...
		if (!this.writtenDocs.has(t.toString()) && e) {
			if (e.isEqual(rt.min())) throw new U(q.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
...
var xa = class {
	constructor(t, e, n, s) {
		this.authCredentials = t, this.appCheckCredentials = e, this.asyncQueue = n, this.databaseInfo = s, this.user = V.UNAUTHENTICATED, this.clientId = tt.A(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this.authCredentials.start(n, (async (t) => {
			N("FirestoreClient", "Received user=", t.uid), await this.authCredentialListener(t), this.user = t;
		})), this.appCheckCredentials.start(n, ((t) => (N("FirestoreClient", "Received new app check token=", t), this.appCheckCredentialListener(t, this.user))));
	}
...
async function ka(t, e) {
	...
	await e.initialize(n, s), t.setCredentialChangeListener(((t) => gc(e.remoteStore, t))), t.setAppCheckTokenChangeListener(((t, n) => gc(e.remoteStore, n))), t._onlineComponents = e;
}
/**
...
/** Disables the network connection. Pending operations will not complete. */ function Qa(t) {
	return t.asyncQueue.enqueue((async () => {
		...
		return e.setNetworkEnabled(!1), async function(t) {
			const e = L(t);
			e.vu.add(0), await Wu(e), e.bu.set("Offline");
		}(n);
	}));
}
/**
...
function Wa(t, e) {
	...
	return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
		try {
			const s = await fu(t, e, !0), i = new Lc(e, s.ir), r = i.sc(s.documents), o = i.applyChanges(r, !1);
...
var ah = class {
	constructor(t) {
		...
		sh("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling), this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalForceLongPolling ? this.experimentalAutoDetectLongPolling = !1 : void 0 === t.experimentalAutoDetectLongPolling ? this.experimentalAutoDetectLongPolling = true : this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, this.experimentalLongPollingOptions = th(null !== (n = t.experimentalLongPollingOptions) && void 0 !== n ? n : {}), function(t) {
...
var hh = class {
	/** @hideconstructor */
	constructor(t, e, n, s) {
		this._authCredentials = t, this._appCheckCredentials = e, this._databaseId = n, this._app = s, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new ah({}), this._settingsFrozen = !1;
	}
	/**
	...
	*/ get app() {
	...
	_setSettings(t) {
		...
		this._settings = new ah(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
			if (!t) return new Q();
			switch (t.type) {
				case "firstParty": return new H(t.sessionIndex || "0", t.iamToken || null, t.authTokenFactory || null);
				case "provider": return t.client;
				default: throw new U(q.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
			}
		}(t.credentials));
	}
	_getSettings() {
...
*/ function lh(t, e, n, s = {}) {
	...
	if ("firestore.googleapis.com" !== r.host && r.host !== e && M("Host has been set in both settings() and useEmulator(), emulator host will be used"), t._setSettings(Object.assign(Object.assign({}, r), {
		host: `${e}:${n}`,
		ssl: !1
	})), s.mockUserToken) {
		let e, n;
		if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = V.MOCK_USER;
		else {
...
*/ function mh(t, e) {
	...
	return new dh(t, null, function(t) {
...
*/ var Ih = class {
	constructor() {
		this.Gc = Promise.resolve(), this.Qc = [], this.jc = !1, this.zc = [], this.Wc = null, this.Hc = !1, this.Jc = !1, this.Yc = [], this.qo = new Bu(this, "async_queue_retry"), this.Xc = () => {
			const t = Ou();
	...
	*/ async ea() {
	...
	ta(t) {
		const e = this.Gc.then((() => (this.Hc = !0, t().catch(((t) => {
			...
			* limitations under the License.
			*/
			throw k("INTERNAL UNHANDLED ERROR: ", function(t) {
				let e = t.message || "";
...
*/ function Rh(t, e, n) {
	...
	if (s.isInitialized(n)) {
		const t = s.getImmediate({ identifier: n });
		if (deepEqual(s.getOptions(n), e)) return t;
...
function Ph(e, n) {
	const s = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : n || "(default)", r = _getProvider(s, "firestore").getImmediate({ identifier: i });
	if (!r._initialized) {
...
function Vh(t) {
	...
	t._firestoreClient = new xa(t._authCredentials, t._appCheckCredentials, t._queue, r), !(null === (n = i.cache) || void 0 === n) && n._offlineComponentProvider && !(null === (s = i.cache) || void 0 === s) && s._onlineComponentProvider && (t._firestoreClient._uninitializedComponentsProvider = {
...
* limitations under the License.
*/ var zh = /^__.*__$/;
/** The result of parsing document data (e.g. for a setData call). */ var Wh = class {
	constructor(t, e, n) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ var Hh = class {
	constructor(t, e, n) {
		this.data = t, this.fieldMask = e, this.fieldTransforms = n;
	}
	toMutation(t, e) {
...
/** A "context" object passed around while parsing user data. */ var Yh = class Yh {
	/**
	...
	*/
	constructor(t, e, n, s, i, r) {
		this.settings = t, this.databaseId = e, this.serializer = n, this.ignoreUndefinedProperties = s, void 0 === i && this.ua(), this.fieldTransforms = i || [], this.fieldMask = r || [];
	}
	get path() {
...
/** Parse document data from a set() call. */ function tl(t, e, n, s, i, r = {}) {
	...
	const u = ll(s, o);
	let c, a;
	if (r.merge) c = new Re(o.fieldMask), a = o.fieldTransforms;
...
var il = class extends Qh {
	...
	_toFieldTransform(t) {
		const e = nl(this, t, !0), s = new Vs(this.pa.map(((t) => hl(t, e))));
...
var rl = class extends Qh {
	...
	_toFieldTransform(t) {
		const e = nl(this, t, !0), s = new Ds(this.pa.map(((t) => hl(t, e))));
		return new Ms(t.path, s);
	}
	isEqual(t) {
		return this === t;
...
/** Parse update data from an update() call. */ function ul(t, e, n, s) {
	...
	ge(s, ((t, s) => {
		...
		const c = i.da(u);
		if (s instanceof el) r.push(u);
		else {
			const t = hl(s, c);
			null != t && (r.push(u), o.set(u, t));
		}
	}));
	return new Hh(o, new Re(r), i.fieldTransforms);
}
/** Parse update data from a list of field/value arguments. */ function cl(t, e, n, s, i, r) {
	...
	for (let t = u.length - 1; t >= 0; --t) if (!yl(a, u[t])) {
		...
		const s = o.da(e);
		if (n instanceof el) a.push(e);
		else {
			const t = hl(n, s);
			null != t && (a.push(e), h.set(e, t));
		}
	}
	return new Hh(h, new Re(a), o.fieldTransforms);
}
/**
...
*/ function hl(t, e) {
	if (fl(t = getModularInstance(t))) return dl("Unsupported field value:", e, t), ll(t, e);
	if (t instanceof Qh)
 /**
	...
	*/
	...
	if (e.path && e.fieldMask.push(e.path), t instanceof Array) {
		...
		return function(t, e) {
			...
			for (const i of t) {
				let t = hl(i, e.wa(s));
				t ??= { nullValue: "NULL_VALUE" }, n.push(t), s++;
			}
			return { arrayValue: { values: n } };
		}(t, e);
	}
	return function(t, e) {
		if (null === (t = getModularInstance(t))) return { nullValue: "NULL_VALUE" };
		...
		if (t instanceof Date) {
			...
			return { timestampValue: Di(e.serializer, n) };
		}
		if (t instanceof it) {
			const n = new it(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
			return { timestampValue: Di(e.serializer, n) };
		}
		if (t instanceof jh) return { geoPointValue: {
			latitude: t.latitude,
			longitude: t.longitude
		} };
		if (t instanceof Uh) return { bytesValue: Ci(e.serializer, t._byteString) };
		if (t instanceof fh) {
			...
			return { referenceValue: ki(t.firestore._databaseId || e.databaseId, t._key.path) };
		}
...
function ll(t, e) {
	const n = {};
	return ye(t) ? e.path && e.path.length > 0 && e.fieldMask.push(e.path) : ge(t, ((t, s) => {
		const i = hl(s, e.ha(t));
		null != i && (n[t] = i);
	})), { mapValue: { fields: n } };
}
...
*/ function wl(t, e, n) {
	if ((e = getModularInstance(e)) instanceof Kh) return e._internalPath;
	if ("string" == typeof e) return ml(t, e);
	throw gl("Field path arguments must be of type string or ", t, !1, void 0, n);
}
/**
* Matches any characters in a field path string that are reserved.
*/ var _l = /* @__PURE__ */ new RegExp("[~\\*/\\[\\]]");
/**
...
* evaluated.
*/ function ml(t, e, n) {
	if (e.search(_l) >= 0) throw gl(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, !1, void 0, n);
	try {
		return new Kh(...e.split("."))._internalPath;
	} catch (s) {
		throw gl(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, !1, void 0, n);
	}
}
		...
		return function(t, e, n, s, i, r, o) {
			...
			if (i.isKeyField()) {
				...
				if ("in" === r || "not-in" === r) {
					...
					u = { arrayValue: { values: e } };
				} else u = Kl(s, t, o);
			} else "in" !== r && "not-in" !== r && "array-contains-any" !== r || Gl(o, r), u = al(n, e, o, "in" === r || "not-in" === r);
...
function Ol(...t) {
	return $l._create("startAt", t, !0);
}
function Fl(...t) {
	return $l._create("startAfter", t, !1);
}
/**
...
function Ll(...t) {
	return Bl._create("endBefore", t, !1);
}
function ql(...t) {
	return Bl._create("endAt", t, !0);
}
/** Helper function to create a bound from a document or fields */ function Ul(t, e, n, s) {
	if (n[0] = getModularInstance(n[0]), n[0] instanceof pl) return function(t, e, n, s, i) {
		...
		const r = [];
		for (const n of Hn(t)) if (n.field.isKeyField()) r.push(We(e, s.key));
		else {
...
*/ function Ql(t, e) {
	...
	if (null !== n) throw n === e.op ? new U(q.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new U(q.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
}
function jl(t, e, n) {
...
var Wl = class {
	convertValue(t, e = "none") {
		switch (Le(t)) {
			...
			case 2: return Ce(t.integerValue || t.doubleValue);
			...
			case 6: return this.convertBytes(xe(t.bytesValue));
	...
	*/ convertObjectMap(t, e = "none") {
	...
	convertServerTimestamp(t, e) {
		switch (e) {
			...
			case "estimate": return this.convertTimestamp(Me(t));
			default: return null;
		}
	}
	convertTimestamp(t) {
		...
		return this._cachedChanges && this._cachedChangesIncludeMetadataChanges === e || (this._cachedChanges = function(t, e) {
			...
			}
			{
				...
				return t._snapshot.docChanges.filter(((t) => e || 3 !== t.type)).map(((e) => {
					...
					let i = -1, r = -1;
					return 0 !== e.type && (i = n.indexOf(e.doc.key), n = n.delete(e.doc.key)), 1 !== e.type && (n = n.add(e.doc), r = n.indexOf(e.doc.key)), {
						type: uf(e.type),
						doc: s,
						oldIndex: i,
						newIndex: r
...
*/ function lf(t) {
	...
	return ja(n, t._key).then(((n) => new sf(e, s, t._key, n, new nf(null !== n && n.hasLocalMutations, !0), t.converter)));
}
/**
...
*/ function ff(t) {
	t = uh(t, fh);
	const e = uh(t.firestore, vh);
	return za(bh(e), t._key, { source: "server" }).then(((n) => Af(e, t, n)));
}
/**
...
*/ function _f(t) {
	t = uh(t, dh);
	const e = uh(t.firestore, vh), n = bh(e), s = new hf(e);
	return Ha(n, t._query, { source: "server" }).then(((n) => new of(e, s, t, n)));
}
function mf(t, e, n) {
	t = uh(t, fh);
...
function gf(t, e, n, ...s) {
	...
	let o;
	o = "string" == typeof (e = getModularInstance(e)) || e instanceof Kh ? cl(r, "updateDoc", t._key, e, n, s) : ul(r, "updateDoc", t._key, e);
...
function If(t, ...e) {
	...
	let r = { includeMetadataChanges: !1 }, o = 0;
	"object" != typeof e[o] || Th(e[o]) || (r = e[o], o++);
	const u = { includeMetadataChanges: r.includeMetadataChanges };
	if (Th(e[o])) {
		const t = e[o];
...
function Tf(t, e) {
	return Ja(bh(t = uh(t, vh)), Th(e) ? e : { next: e });
}
/**
...
*/ function Af(t, e, n) {
	...
	return new sf(t, new hf(t), e._key, s, new nf(n.hasPendingWrites, n.fromCache), e.converter);
}
/**
* @license
* Copyright 2022 Google LLC
...
*/ function Rf(t, e) {
	...
	}(s, t._query, i).then(((e) => function(t, e, n) {
		return new qh(e, new hf(t), n);
	}(n, t, e)));
	/**
	* @license
	* Copyright 2023 Google LLC
...
var Bf = class {
	/** @hideconstructor */
	constructor(t, e) {
		this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, this._dataReader = Zh(t);
	}
	set(t, e, n) {
	...
	update(t, e, n, ...s) {
		...
		let r;
		return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Kh ? cl(this._dataReader, "WriteBatch.update", i._key, e, n, s) : ul(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, Fs.exists(!0))), this;
	}
	/**
...
var qf = class extends class {
	...
	*/ get(t) {
	...
	update(t, e, n, ...s) {
		const i = Lf(t, this._firestore);
		let r;
		return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Kh ? cl(this._dataReader, "Transaction.update", i._key, e, n, s) : ul(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
	}
	/**
	* Deletes the document referred to by the provided {@link DocumentReference}.
	*
	...
	*/ get(t) {
		...
		return super.get(t).then(((t) => new sf(this._firestore, n, e._key, t._document, new nf(!1, !1), e.converter)));
	}
};
/**
...
*/ function Hf(t, e) {
	...
	if (!s._uninitializedComponentsProvider || "memory" === (null === (n = s._uninitializedComponentsProvider) || void 0 === n ? void 0 : n._offlineKind)) return M("Cannot enable indexes when persistence is disabled"), Promise.resolve();
	return Za(s, function(t) {
...
*/ (function(t, e = !0) {
	(function(t) {
		...
		return s = Object.assign({ useFetchStreams: e }, s), r._setSettings(s), r;
	}), "PUBLIC").setMultipleInstances(!0)), registerVersion(b, "3.12.1", t), registerVersion(b, "3.12.1", "esm2017");
})();
//#endregion
