...
function getDbPromise() {
	if (!dbPromise) dbPromise = openDB(DB_NAME, DB_VERSION, { upgrade: (db, oldVersion) => {
		switch (oldVersion) {
			case 0: db.createObjectStore(STORE_NAME);
		}
	} }).catch((e) => {
...
async function readHeartbeatsFromIndexedDB(app) {
	try {
		return await (await getDbPromise()).transaction(STORE_NAME).objectStore(STORE_NAME).get(computeKey(app));
	} catch (e) {
...
var STORED_HEARTBEAT_RETENTION_MAX_MILLIS = 720 * 60 * 60 * 1e3;
...
var HeartbeatStorageImpl = class {
	...
	*/
	async read() {
		...
		else return await readHeartbeatsFromIndexedDB(this.app) || { heartbeats: [] };
	}
...
//#endregion
export { getDefaultEmulatorHost as A, isReactNative as B, areCookiesEnabled as C, createSubscribe as D, createMockUserToken as E, isBrowserExtension as F, querystring as H, isEmpty as I, isIE as L, getExperimentalSetting as M, getModularInstance as N, deepEqual as O, getUA as P, isIndexedDBAvailable as R, FirebaseError as S, calculateBackoffMillis as T, querystringDecode as U, isSafari as V, validateIndexedDBOpenable as W, setLogLevel as _, _apps as a, Component as b, _getProvider as c, deleteApp as d, getApp as f, registerVersion as g, onLog as h, _addOrOverwriteComponent as i, getDefaultEmulatorHostnameAndPort as j, extractQuerystring as k, _registerComponent as l, initializeApp as m, SDK_VERSION as n, _clearComponents as o, getApps as p, _addComponent as r, _components as s, DEFAULT_ENTRY_NAME as t, _removeServiceInstance as u, LogLevel as v, base64Decode as w, ErrorFactory as x, Logger as y, isMobileCordova as z };

//# sourceMappingURL=index.esm2017-DGyNZ426.js.map